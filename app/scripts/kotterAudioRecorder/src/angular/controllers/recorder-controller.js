...
var RecorderController = function(element, service, recorderUtils, $scope, $rootScope, $timeout,
    $interval, PLAYBACK) {
    ...
    control.savetoServer = function(index) {
        $rootScope.saveToServer(index);
    };
    ...
    control.startRecord = function() {
        ...
        var start = function() {
            ...
            timing = $interval(function() {
                ++control.elapsedTime;
                if (control.timeLimit && control.timeLimit > 0 && control.elapsedTime >=
                    control.timeLimit) {
                    control.stopRecord();
                }
            }, 1000);
