    ...
    return (function e(t, n, r) {
        ...
        1: [function(_dereq_, module, exports) {
            (function(global) {
                ...
                var _typeof2 = typeof Symbol === "function" && typeof Symbol
                    .iterator === "symbol" ? function(obj) {
                        return typeof obj;
                    } : function(obj) {
                ...
                var _typeof = typeof Symbol === "function" && _typeof2(
                ...
                var FormioUtils = {
                    ...
                    isLayoutComponent: function isLayoutComponent(
                        component) {
                        return component.columns && Array.isArray(
                                component.columns) || component.rows &&
                            Array.isArray(component.rows) ||
                            component.components && Array.isArray(
                     ...
                     *   The parent object.
                     */
                    eachComponent: function eachComponent(components,
                        fn, includeAll, path, parent) {
                        if (!components) return;
                        path = path || '';
                        components.forEach(function(component) {
                            var hasColumns = component.columns &&
                                Array.isArray(component.columns);
                            var hasRows = component.rows &&
                                Array.isArray(component.rows);
                            var hasComps = component.components &&
                     ...
                     * @return {boolean}
                     */
                    matchComponent: function matchComponent(component,
                        query) {
                    ...
                    getComponent: function getComponent(components, key) {
                        var result;
                        FormioUtils.eachComponent(components,
                            function(component, path) {
                                if (FormioUtils.matchComponent(
                                        component, key)) {
                                    component.path = path;
                                    result = component;
                                    return true;
                     ...
                     * @return {*}
                     */
                    findComponents: function findComponents(components,
                        query) {
                        var results = [];
                        FormioUtils.eachComponent(components,
                            function(component, path) {
                     ...
                     */
                    flattenComponents: function flattenComponents(
                        components, includeAll) {
                        var flattened = {};
                        FormioUtils.eachComponent(components,
                            function(component, path) {
                    ...
                    hasCondition: function hasCondition(component) {
                        return component.hasOwnProperty(
                            ...
                            component.hasOwnProperty('conditional') &&
                            component.conditional && component.conditional
                            .when || component.hasOwnProperty(
                                'conditional') && component.conditional &&
                            component.conditional.json ? true :
                            false;
                    },
                    ...
                    parseFloat: function(_parseFloat) {
                        ...
                        return parseFloat((0, _isString3.default)
                            (value) ? value.replace(
                                /[^\de.+-]/gi, '') : value);
                    }),
                    ...
                    formatAsCurrency: function formatAsCurrency(value) {
                        ...
                        var parts = (0, _round3.default)(
                            parsedValue, 2).toString().split(
                            '.');
                        parts[0] = (0, _chunk3.default)(Array.from(
                            parts[0]).reverse(), 3).reverse().map(
                            function(part) {
                                return part.reverse().join('');
                            }).join(',');
                        parts[1] = (0, _pad3.default)(parts[1], 2,
                            '0');
                        return parts.join('.');
                    },
                     ...
                     */
                    escapeRegExCharacters: function escapeRegExCharacters(
                        value) {
                     ...
                     */
                    checkCalculated: function checkCalculated(component,
                        submission, data) {
                        // Process calculated value stuff if present.
                        if (component.calculateValue) {
                            if (typeof component.calculateValue ===
                                'string') {
                                try {
                                    var util = this;
                                    data[component.key] = eval(
                                        '(function(data, util) { var value = [];' +
                                        component.calculateValue
                                        .toString() +
                                        '; return value; })(data, util)'
                                    );
                                } catch (e) {
                                    console.warn(
                                        'An error occurred calculating a value for ' +
                                        component.key, e);
                                }
                            } else {
                                try {
                                    data[component.key] =
                                        FormioUtils.jsonLogic.apply(
                                            component.calculateValue, {
                                                data: submission ?
                     ...
                     * @returns {boolean}
                     */
                    checkCondition: function checkCondition(component,
                        row, data) {
                        if (component.hasOwnProperty(
                                'customConditional') && component.customConditional) {
                            try {
                                var script =
                                    '(function() { var show = true;';
                                script += component.customConditional
                                    .toString();
                                script += '; return show; })()';
                                ...
                                console.warn(
                                    'An error occurred in a custom conditional statement for component ' +
                                    component.key, e);
                                return true;
                            }
                        } else if (component.hasOwnProperty(
                                'conditional') && component.conditional &&
                            ...
                            if (data && (value === null || typeof value ===
                                    'undefined')) {
                                value = this.getValue({
                                    data: data
                                }, cond.when);
                            ...
                            if ((typeof value === 'undefined' ?
                                ...
                                'object' && value.hasOwnProperty(
                                    cond.eq)) {
                                return value[cond.eq].toString() ===
                                    cond.show.toString();
                            }
                            // FOR-179 - Check for multiple values.
                            if (value instanceof Array && value.indexOf(
                                    cond.eq) !== -1) {
                                return cond.show.toString() ===
                                    'true';
                            }

                            return value.toString() === cond.eq.toString() ===
                                (cond.show.toString() === 'true');
                        } else if (component.hasOwnProperty(
                                'conditional') && component.conditional &&
                            component.conditional.json) {
                            return _jsonLogicJs2.default.apply(
                                component.conditional.json, {
                                    data: data,
                                    row: row
                                });
                    ...
                    interpolate: function interpolate(string, data) {
                        ...
                        try {
                            return (0, _template2.default)(string,
                    ...
                    uniqueName: function uniqueName(name) {
                        var parts = name.toLowerCase().replace(
                            /[^0-9a-z\.]/g, '').split('.');
                        ...
                        return fileName.substr(0, 10) + '-' + this.guid() +
                            ext;
                    },
                ...
                var operations = {
                    ...
                    "missing": function() {
                        ...
                        */
                        ...
                        var missing = [];
                        var keys = Array.isArray(arguments[0]) ?
                    ...
                    "missing_some": function(need_count, options) {
                        ...
                        if (options.length - are_missing.length >=
                            need_count) {
                            return [];
                        } else {
                            return are_missing;
                    ...
                    if (op === "if" || op == "?:") {
                        ...
                        */
                        for (i = 0; i < values.length - 1; i += 2) {
                            if (jsonLogic.truthy(jsonLogic.apply(
                                    values[i], data))) {
                                return jsonLogic.apply(values[i + 1],
                                    data);
                            }
                        }
                        if (values.length === i + 1) return jsonLogic
                            .apply(values[i], data);
                        return null;
                    } else if (op === "and") { // Return first falsy, or last
                        for (i = 0; i < values.length; i += 1) {
                            current = jsonLogic.apply(values[i],
                                data);
                        ...
                        scopedData = jsonLogic.apply(values[0],
                            data);
                        ...
                        scopedData = jsonLogic.apply(values[0],
                            data);
                        scopedLogic = values[1];
                        initial = typeof values[2] !== 'undefined' ?
                            values[2] : null;
                ...
                jsonLogic.rule_like = function(rule, pattern) {
                    ...
                    if (jsonLogic.is_logic(pattern)) {
                        if (jsonLogic.is_logic(rule)) {
                            var pattern_op = jsonLogic.get_operator(
                                pattern);
                            var rule_op = jsonLogic.get_operator(
                                rule);

                            if (pattern_op === "@" || pattern_op ===
                                rule_op) {
                                // echo "\nOperators match, go deeper\n";
                                return jsonLogic.rule_like(
                                    jsonLogic.get_values(rule,
                                        false),
                                    jsonLogic.get_values(
                                        pattern, false)
                                );
                            }
                        }
            ...
            function baseClone(value, bitmask, customizer, key, object, stack) {
                ...
                arrayEach(props || value, function(subValue, key) {
                    ...
                    assignValue(result, key, baseClone(subValue,
                        bitmask, customizer, key, value, stack));
                });
                return result;
            }
        ...
        41: [function(_dereq_, module, exports) {
            ...
            function baseDifference(array, values, iteratee, comparator) {
                ...
                outer:
                    while (++index < length) {
                        var value = array[index],
                            computed = iteratee == null ? value : iteratee(
                                value);
                ...
                while (++index < length) {
                    ...
                    if (depth > 0 && predicate(value)) {
                        if (depth > 1) {
                            ...
                            baseFlatten(value, depth - 1, predicate, isStrict,
                                result);
                        } else {
        ...
        49: [function(_dereq_, module, exports) {
            ...
            function baseGetAllKeys(object, keysFunc, symbolsFunc) {
                ...
                return isArray(object) ? result : arrayPush(result, symbolsFunc(
                    object));
            }
        ...
        52: [function(_dereq_, module, exports) {
            var baseFindIndex = _dereq_('./_baseFindIndex'),
                ...
                strictIndexOf = _dereq_('./_strictIndexOf');
        ...
        54: [function(_dereq_, module, exports) {
            ...
            function baseIsEqual(value, other, bitmask, customizer, stack) {
                ...
                return baseIsEqualDeep(value, other, bitmask, customizer,
                    baseIsEqual, stack);
            }
        ...
        55: [function(_dereq_, module, exports) {
             ...
             */
            function baseIsEqualDeep(object, other, bitmask, customizer,
                equalFunc, stack) {
                ...
                if (isSameTag && !objIsObj) {
                    ...
                    return (objIsArr || isTypedArray(object)) ?
                        equalArrays(object, other, bitmask, customizer,
                            equalFunc, stack) :
                        equalByTag(object, other, objTag, bitmask, customizer,
                            equalFunc, stack);
                }
                if (!(bitmask & COMPARE_PARTIAL_FLAG)) {
                    var objIsWrapped = objIsObj && hasOwnProperty.call(object,
                            '__wrapped__'),
                        othIsWrapped = othIsObj && hasOwnProperty.call(other,
                            '__wrapped__');

                    if (objIsWrapped || othIsWrapped) {
                        var objUnwrapped = objIsWrapped ? object.value() :
                            object,
                ...
                stack || (stack = new Stack);
                return equalObjects(object, other, bitmask, customizer,
                    equalFunc, stack);
            }
                    ...
                    if (noCustomizer && data[2]) {
                        ...
                        if (!(result === undefined ?
                                baseIsEqual(srcValue, objValue,
                                    ...
                                    COMPARE_UNORDERED_FLAG, customizer, stack) :
                                result
                            )) {
                            return false;
                        }
        ...
        62: [function(_dereq_, module, exports) {
            ...
            function baseKeysIn(object) {
                ...
                for (var key in object) {
                    if (!(key == 'constructor' && (isProto || !hasOwnProperty.call(
                            object, key)))) {
                        result.push(key);
                    }
                }
        ...
        64: [function(_dereq_, module, exports) {
            ...
            function baseMatches(source) {
                ...
                if (matchData.length == 1 && matchData[0][2]) {
                    return matchesStrictComparable(matchData[0][0], matchData[0]
                        [1]);
                }
                return function(object) {
                    return object === source || baseIsMatch(object, source,
                        matchData);
                };
            }
                ...
                baseFor(source, function(srcValue, key) {
                    if (isObject(srcValue)) {
                        ...
                        var newValue = customizer ?
                            customizer(object[key], srcValue, (key + ''),
                                object, source, stack) :
                            undefined;
        ...
        67: [function(_dereq_, module, exports) {
             ...
             *  counterparts.
             */
            function baseMergeDeep(object, source, key, srcIndex, mergeFunc,
                customizer, stack) {
                var objValue = object[key],
                    srcValue = source[key],
                ...
                if (isCommon) {
                    ...
                    if (isArr || isBuff || isTyped) {
                        ...
                        } else if (!isObject(objValue) || (srcIndex &&
                                isFunction(objValue))) {
        ...
        72: [function(_dereq_, module, exports) {
            ...
            function baseRange(start, end, step, fromRight) {
                var index = -1,
                    length = nativeMax(nativeCeil((end - start) / (step || 1)),
                        0),
                    result = Array(length);
            ...
            function baseSet(object, path, value, customizer) {
                ...
                while (nested != null && ++index < length) {
                    ...
                    if (index != lastIndex) {
                        ...
                        newValue = customizer ? customizer(objValue, key,
                            nested) : undefined;
                        if (newValue === undefined) {
        ...
        76: [function(_dereq_, module, exports) {
             ...
             */
            var baseSetToString = !defineProperty ? identity : function(func,
                string) {
        ...
        79: [function(_dereq_, module, exports) {
            ...
            function baseToString(value) {
                ...
                var result = (value + '');
                return (result == '0' && (1 / value) == -INFINITY) ? '-0' :
                    result;
            }
        ...
        84: [function(_dereq_, module, exports) {
            ...
            function castPath(value, object) {
                ...
                return isKey(value, object) ? [value] : stringToPath(toString(
                    value));
            }
        ...
        85: [function(_dereq_, module, exports) {
            ...
            function castSlice(array, start, end) {
                ...
                return (!start && end >= length) ? array : baseSlice(array,
                    start, end);
            }
        ...
        87: [function(_dereq_, module, exports) {
            ...
            function cloneBuffer(buffer, isDeep) {
                ...
                var length = buffer.length,
                    result = allocUnsafe ? allocUnsafe(length) : new buffer.constructor(
                        length);
        ...
        88: [function(_dereq_, module, exports) {
            ...
            function cloneDataView(dataView, isDeep) {
                var buffer = isDeep ? cloneArrayBuffer(dataView.buffer) :
                    dataView.buffer;
        ...
        89: [function(_dereq_, module, exports) {
            ...
            function cloneMap(map, isDeep, cloneFunc) {
                var array = isDeep ? cloneFunc(mapToArray(map), CLONE_DEEP_FLAG) :
                    mapToArray(map);
        ...
        90: [function(_dereq_, module, exports) {
            ...
            function cloneRegExp(regexp) {
                var result = new regexp.constructor(regexp.source, reFlags.exec(
                    regexp));
        ...
        91: [function(_dereq_, module, exports) {
            ...
            function cloneSet(set, isDeep, cloneFunc) {
                var array = isDeep ? cloneFunc(setToArray(set), CLONE_DEEP_FLAG) :
                    setToArray(set);
        ...
        95: [function(_dereq_, module, exports) {
            ...
            function copyObject(source, props, object, customizer) {
                ...
                while (++index < length) {
                    ...
                    var newValue = customizer ?
                        customizer(object[key], source[key], key, object,
                            source) :
                        undefined;
        ...
        99: [function(_dereq_, module, exports) {
            ...
            function createAggregator(setter, initializer) {
                return function(collection, iteratee) {
                    var func = isArray(collection) ? arrayAggregator :
                        baseAggregator,
                        accumulator = initializer ? initializer() : {};

                    return func(collection, setter, baseIteratee(iteratee,
                        2), accumulator);
                };
            }
            ...
            function createAssigner(assigner) {
                return baseRest(function(object, sources) {
                    var index = -1,
                        ...
                        customizer = length > 1 ? sources[length - 1] :
                        undefined,
                        guard = length > 2 ? sources[2] : undefined;

                    customizer = (assigner.length > 3 && typeof customizer ==
                            'function') ?
                        (length--, customizer) :
                        undefined;

                    if (guard && isIterateeCall(sources[0], sources[1],
                            guard)) {
                        customizer = length < 3 ? undefined :
                            customizer;
                        length = 1;
                    }
                    object = Object(object);
        ...
        104: [function(_dereq_, module, exports) {
            ...
            function createCompounder(callback) {
                return function(string) {
                    return arrayReduce(words(deburr(string).replace(reApos,
                        '')), callback, '');
                };
            }
        ...
        107: [function(_dereq_, module, exports) {
            ...
            function createRound(methodName) {
                ...
                return function(number, precision) {
                    ...
                    precision = precision == null ? 0 : nativeMin(toInteger(
                        precision), 292);
                    if (precision) {
                        // Shift with exponential notation to avoid floating-point issues.
                        // See [MDN](https://mdn.io/round#Examples) for more details.
                        var pair = (toString(number) + 'e').split('e'),
                            value = func(pair[0] + 'e' + (+pair[1] +
                                precision));
        ...
        108: [function(_dereq_, module, exports) {
            ...
            function customDefaultsAssignIn(objValue, srcValue, key, object) {
                if (objValue === undefined ||
                    (eq(objValue, objectProto[key]) && !hasOwnProperty.call(
                        object, key))) {
                    return srcValue;
                }
                return objValue;
        ...
        111: [function(_dereq_, module, exports) {
             ...
             */
            function equalArrays(array, other, bitmask, customizer, equalFunc,
                stack) {
                var isPartial = bitmask & COMPARE_PARTIAL_FLAG,
                    arrLength = array.length,
                    othLength = other.length;

                if (arrLength != othLength && !(isPartial && othLength >
                        arrLength)) {
                    return false;
                }
                ...
                var index = -1,
                    result = true,
                    seen = (bitmask & COMPARE_UNORDERED_FLAG) ? new SetCache :
                    undefined;
                ...
                while (++index < arrLength) {
                    ...
                    if (customizer) {
                        var compared = isPartial ?
                            customizer(othValue, arrValue, index, other, array,
                                stack) :
                            customizer(arrValue, othValue, index, array, other,
                                stack);
                    }
                    ...
                    if (seen) {
                        if (!arraySome(other, function(othValue, othIndex) {
                                if (!cacheHas(seen, othIndex) &&
                                    (arrValue === othValue || equalFunc(
                                        arrValue, othValue, bitmask,
                                        customizer, stack))) {
                            ...
                            arrValue === othValue ||
                            equalFunc(arrValue, othValue, bitmask, customizer,
                                stack)
                        )) {
                        result = false;
                        break;
        ...
        112: [function(_dereq_, module, exports) {
             ...
             * @returns {boolean} Returns `true` if the objects are equivalent, else `false`.
             */
            function equalByTag(object, other, tag, bitmask, customizer,
                equalFunc, stack) {
                switch (tag) {
                    case dataViewTag:
                    ...
                    case arrayBufferTag:
                        if ((object.byteLength != other.byteLength) ||
                            !equalFunc(new Uint8Array(object), new Uint8Array(
                                other))) {
                            return false;
                        }
                        return true;
                    ...
                    case errorTag:
                        return object.name == other.name && object.message ==
                            other.message;
                    ...
                    case symbolTag:
                        if (symbolValueOf) {
                            return symbolValueOf.call(object) == symbolValueOf.call(
                                other);
                        }
                }
                return false;
        ...
        113: [function(_dereq_, module, exports) {
             ...
             * @returns {boolean} Returns `true` if the objects are equivalent, else `false`.
             */
            function equalObjects(object, other, bitmask, customizer, equalFunc,
                stack) {
                var isPartial = bitmask & COMPARE_PARTIAL_FLAG,
                ...
                while (index--) {
                    ...
                    if (!(isPartial ? key in other : hasOwnProperty.call(other,
                            key))) {
                        return false;
                    }
                }
                ...
                while (++index < objLength) {
                    ...
                    if (customizer) {
                        var compared = isPartial ?
                            customizer(othValue, objValue, key, other, object,
                                stack) :
                            customizer(objValue, othValue, key, object, other,
                                stack);
                    }
                    // Recursively compare objects (susceptible to call stack limits).
                    if (!(compared === undefined ?
                            (objValue === othValue || equalFunc(objValue,
        ...
        126: [function(_dereq_, module, exports) {
            ...
            if ((DataView && getTag(new DataView(new ArrayBuffer(1))) !=
                    dataViewTag) ||
                ...
                getTag = function(value) {
                    var result = baseGetTag(value),
                        Ctor = result == objectTag ? value.constructor :
                        undefined,
        ...
        134: [function(_dereq_, module, exports) {
            ...
            function hashHas(key) {
                var data = this.__data__;
                return nativeCreate ? (data[key] !== undefined) :
        ...
        136: [function(_dereq_, module, exports) {
            ...
            function initCloneArray(array) {
                ...
                if (length && typeof array[0] == 'string' && hasOwnProperty.call(
                        array, 'index')) {
        ...
        139: [function(_dereq_, module, exports) {
            ...
            /** Built-in value references. */
            var spreadableSymbol = Symbol ? Symbol.isConcatSpreadable :
                undefined;
        ...
        143: [function(_dereq_, module, exports) {
            ...
            function isKeyable(value) {
                var type = typeof value;
                return (type == 'string' || type == 'number' || type ==
                        'symbol' || type == 'boolean') ?
                    (value !== '__proto__') :
                    (value === null);
            }
        ...
        144: [function(_dereq_, module, exports) {
            ...
            var maskSrcKey = (function() {
                var uid = /[^.]+$/.exec(coreJsData && coreJsData.keys &&
        ...
        166: [function(_dereq_, module, exports) {
            ...
            function overRest(func, start, transform) {
                start = nativeMax(start === undefined ? (func.length - 1) :
                    start, 0);
                return function() {
                    var args = arguments,
                        index = -1,
        ...
        170: [function(_dereq_, module, exports) {
            ...
            var freeSelf = typeof self == 'object' && self && self.Object ===
                Object && self;
        ...
        184: [function(_dereq_, module, exports) {
            ...
            var stringToPath = memoizeCapped(function(string) {
                ...
                string.replace(rePropName, function(match, number,
                    quote, string) {
                    result.push(quote ? string.replace(
                        reEscapeChar, '$1') : (number ||
                        match));
                });
                return result;
            });
        ...
        187: [function(_dereq_, module, exports) {
            ...
            var reOptMod = rsModifier + '?',
                ...
                rsSymbol = '(?:' + [rsNonAstral + rsCombo + '?', rsCombo,
                    rsRegional, rsSurrPair, rsAstral
                ].join('|') + ')';

            /** Used to match [string symbols](https://mathiasbynens.be/notes/javascript-unicode). */
            var reUnicode = RegExp(rsFitz + '(?=' + rsFitz + ')|' + rsSymbol +
                rsSeq, 'g');
        ...
        189: [function(_dereq_, module, exports) {
            ...
            var rsAstralRange = '\\ud800-\\udfff',
                ...
                rsVarRange = '\\ufe0e\\ufe0f',
                rsBreakRange = rsMathOpRange + rsNonCharRange +
                rsPunctuationRange + rsSpaceRange;
            ...
            var rsApos = "['\u2019]",
                ...
                rsMisc = '[^' + rsAstralRange + rsBreakRange + rsDigits +
                rsDingbatRange + rsLowerRange + rsUpperRange + ']',
                rsFitz = '\\ud83c[\\udffb-\\udfff]',
                rsModifier = '(?:' + rsCombo + '|' + rsFitz + ')',
                rsNonAstral = '[^' + rsAstralRange + ']',
                rsRegional = '(?:\\ud83c[\\udde6-\\uddff]){2}',
            ...
            var reUnicodeWord = RegExp([
                ...
                rsMiscUpper + '+' + rsOptContrUpper + '(?=' + [rsBreak,
                    rsUpper + rsMiscLower, '$'
                ].join('|') + ')',
        ...
        191: [function(_dereq_, module, exports) {
             ...
             * // => { 'a': 1, 'b': 2 }
             */
            var assignInWith = createAssigner(function(object, source, srcIndex,
                customizer) {
        ...
        195: [function(_dereq_, module, exports) {
            ...
            function chunk(array, size, guard) {
                if ((guard ? isIterateeCall(array, size, guard) : size ===
                        undefined)) {
                    size = 1;
                } else {
        ...
        200: [function(_dereq_, module, exports) {
            ...
            var difference = baseRest(function(array, values) {
                return isArrayLikeObject(array) ?
                    baseDifference(array, baseFlatten(values, 1,
        ...
        209: [function(_dereq_, module, exports) {
            ...
            var isArguments = baseIsArguments(function() {
                ...
                return isObjectLike(value) && hasOwnProperty.call(value,
                        'callee') &&
        ...
        214: [function(_dereq_, module, exports) {
            ...
            function isError(value) {
                ...
                return tag == errorTag || tag == domExcTag ||
                    (typeof value.message == 'string' && typeof value.name ==
        ...
        222: [function(_dereq_, module, exports) {
            ...
            function isString(value) {
                return typeof value == 'string' ||
                    (!isArray(value) && isObjectLike(value) && baseGetTag(value) ==
                        stringTag);
            }
        ...
        225: [function(_dereq_, module, exports) {
            ...
            function keys(object) {
                return isArrayLike(object) ? arrayLikeKeys(object) : baseKeys(
                    object);
            }
        ...
        226: [function(_dereq_, module, exports) {
            ...
            function keysIn(object) {
                return isArrayLike(object) ? arrayLikeKeys(object, true) :
                    baseKeysIn(object);
            }
        ...
        228: [function(_dereq_, module, exports) {
            ...
            function memoize(func, resolver) {
                ...
                var memoized = function() {
                    var args = arguments,
                        key = resolver ? resolver.apply(this, args) : args[
                            0],
        ...
        234: [function(_dereq_, module, exports) {
            ...
            function property(path) {
                return isKey(path) ? baseProperty(toKey(path)) :
        ...
        240: [function(_dereq_, module, exports) {
            ...
            function template(string, options, guard) {
                ...
                var reDelimiters = RegExp(
                    ...
                    interpolate.source + '|' +
                    (interpolate === reInterpolate ? reEsTemplate :
                        reNoMatch).source + '|' +
                ...
                string.replace(reDelimiters, function(match, escapeValue,
                    interpolateValue, esTemplateValue, evaluateValue,
                    offset) {
                    ...
                    source += string.slice(index, offset).replace(
                        reUnescapedString, escapeStringChar);
                ...
                var result = attempt(function() {
                    return Function(importsKeys, sourceURL + 'return ' +
                            source)
            ...
            "./_baseValues": 81,
            "./_customDefaultsAssignIn": 108,
            "./_escapeStringChar": 115,
            "./_isIterateeCall": 141,
            "./_reInterpolate": 169,
            "./assignInWith": 191,
            "./attempt": 192,
        ...
        243: [function(_dereq_, module, exports) {
            ...
            function toInteger(value) {
                ...
                return result === result ? (remainder ? result - remainder :
                    result) : 0;
            }
        ...
        249: [function(_dereq_, module, exports) {
            ...
            function words(string, pattern, guard) {
                ...
                if (pattern === undefined) {
                    return hasUnicodeWord(string) ? unicodeWords(string) :
                        asciiWords(string);
                }
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        ...
                        $templateCache.put(
                            'formio/components/address/display.html',
                            '<ng-form>' +
                        ...
                        $templateCache.put(
                            'formio/components/address/validate.html',
                            '<ng-form>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/button/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<div class="form-group">' +
        ...
        252: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                app.config([
                    'formioComponentsProvider',
                    function(formioComponentsProvider) {
                        formioComponentsProvider.register(
                            'checkbox', {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/checkbox/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            // '<div class="form-group">' +
                        ...
                        $templateCache.put(
                            'formio/components/checkbox/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
                            '<form-builder-option property="validate.customMessage"></form-builder-option>' +
        ...
        253: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        $templateCache.put(
                            'formio/formbuilder/columns.html',
                            '<div class="row">' +
                        ...
                        $templateCache.put(
                            'formio/components/columns/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="customClass"></form-builder-option>' +
                            '<div class="form-group">' +
            ...
            module.exports = function(app) {
                app.run([
                    ...
                    function($templateCache) {
                        ...
                        $templateCache.put(
                            'formio/components/settings.html',
                            ...
                            '<button type="button" ng-if="!component.disableRemove" class="btn btn-danger" ng-click="removeComponent(component, formComponents[component.type].confirmRemove); closeThisDialog(false)">{{\'Remove\' | formioTranslate}}</button>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</form>'
                        ...
                        $templateCache.put(
                            'formio/components/common/data.html',
                        ...
                        // Create the common API tab markup.
                        $templateCache.put(
                            'formio/components/common/api.html',
                            '<ng-form>' +
                        ...
                        $templateCache.put(
                            'formio/components/common/layout.html',
                            '<ng-form>' +
                        ...
                        // Create the common Layout tab markup.
                        $templateCache.put(
                            'formio/components/common/conditional.html',
        ...
        255: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        $templateCache.put(
                            'formio/components/container/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option property="tooltip"></form-builder-option>' +
                        ...
                        $templateCache.put(
                            'formio/formbuilder/container.html',
                            '<fieldset>' +
        ...
        256: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        $templateCache.put(
                            'formio/formbuilder/content.html',
                            '<div class="form-group">' +
                            '<textarea ckeditor="ckeditorOptions" ng-model="component.html"><textarea>' +
                            '</div>'
                        );
                        $templateCache.put(
                            'formio/components/common/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="customClass"></form-builder-option>' +
                            '</ng-form>'
                        );
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/currency/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option property="errorLabel"></form-builder-option>' +
                        ...
                        $templateCache.put(
                            'formio/components/currency/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
                            '<form-builder-option property="validate.customMessage"></form-builder-option>' +
                            '<form-builder-option-custom-validation></form-builder-option-custom-validation>' +
            ...
            module.exports = function(app) {
                ...
                app.controller('customComponent', [
                    ...
                    function(
                        ...
                        $scope.customComponent = angular.copy(
                            $scope.component);
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/custom/display.html',
                            '<ng-form>' +
                            '<div class="form-group">' +
        ...
        259: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        $templateCache.put(
                            'formio/components/datagrid/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option property="tooltip"></form-builder-option>' +
                            '<form-builder-option property="errorLabel"></form-builder-option>' +
                        ...
                        $templateCache.put(
                            'formio/components/datagrid/validate.html',
                            '<ng-form>' +
            ...
            module.exports = function(app) {
                        ...
                        formioComponentsProvider.register(
                            'datetime', {
                                onEdit: ['$scope', function(
                                    ...
                                    $scope.$watch(
                                        'component.timePicker.showMeridian',
                                        function(
                                            value) {
                                            var _old =
                                                value ?
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/datetime/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                        ...
                        $templateCache.put(
                            'formio/components/datetime/date.html',
                            '<ng-form>' +
                            '<div class="checkbox">' +
                        ...
                        $templateCache.put(
                            'formio/components/datetime/time.html',
                            '<ng-form>' +
                            '<div class="checkbox">' +
                        ...
                        $templateCache.put(
                            'formio/components/datetime/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
                            '<form-builder-option property="validate.customMessage"></form-builder-option>' +
                            '<form-builder-option-custom-validation></form-builder-option-custom-validation>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/day/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                        ...
                        $templateCache.put(
                            'formio/components/day/validate.html',
                            '<ng-form>' +
        ...
        262: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        $templateCache.put(
                            'formio/components/editgrid/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option property="tooltip"></form-builder-option>' +
                            '<form-builder-option property="clearOnHide"></form-builder-option>' +
                        ...
                        $templateCache.put(
                            'formio/components/editgrid/validate.html',
                            '<ng-form>' +
                        ...
                        $templateCache.put(
                            'formio/formbuilder/editgrid.html',
                            '<fieldset>' +
        ...
        263: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                app.config([
                    'formioComponentsProvider',
                    function(formioComponentsProvider) {
                        var views = _cloneDeep(
                            formioComponentsProvider.$get().components
                            .textfield.views);
                        _each(views, function(view) {
                            if (view.name === 'Validation') {
                                view.template =
                                    'formio/components/email/validate.html';
                            }
                        });
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        ...
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/fieldset/display.html',
                            '<ng-form>' +
                            '<p>This component is used to demarcate different sections of your template by adding a border around a group of templates.</p>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/file/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option property="tooltip"></form-builder-option>' +
                        ...
                        $templateCache.put(
                            'formio/components/file/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
                            '<form-builder-option property="validate.customMessage"></form-builder-option>' +
                            '</ng-form>'
        ...
        266: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                    ...
                    function(formioComponentsProvider) {
                        formioComponentsProvider.register('form', {
                            ...
                            onEdit: ['$scope', function(
                                $scope) {
                                $scope.forms = [];
                                $scope.component.project =
                                    $scope.formio.projectId;
                ...
                app.run([
                    ...
                    function($templateCache) {
                        $templateCache.put(
                            'formio/formbuilder/form.html',
                            '<span class="hidden-element-text">{{ form.title }} {{ form.type }}</span>'
                        );

                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/form/display.html',
                            '<ng-form>' +
        ...
        267: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        $templateCache.put(
                            'formio/formbuilder/hidden.html',
                            '<span class="hidden-element-text">{{ component.label }}</span>'
                        );

                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/hidden/display.html',
                            '<ng-form>' +
                        ...
                        $templateCache.put(
                            'formio/components/hidden/validation.html',
                            '<ng-form>' +
                            '<form-builder-option property="unique"></form-builder-option>' +
                            '</ng-form>'
                        );
        ...
        268: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        $templateCache.put(
                            'formio/formbuilder/htmlelement.html',
                            '<formio-html-element component="component"></div>'
                        );

                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/htmlelement/display.html',
                            '<ng-form>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/number/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option property="placeholder"></form-builder-option>' +
                        ...
                        // Create the API markup.
                        $templateCache.put(
                            'formio/components/number/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        ...
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/panel/display.html',
                            '<ng-form>' +
                        ...
                        $templateCache.put(
                            'formio/components/panel/conditional.html',
                            '<form-builder-conditional></form-builder-conditional>' +
                            '<uib-accordion>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function(
                        ...
                        var textFieldTmpl = $templateCache.get(
                            'formio/components/textfield.html');
                        var passwordTmpl = textFieldTmpl.replace(
                            /<input type="{{ component.inputType }}" /g,
                            '<input type="{{ component.inputType }}" dnd-nodrag '
                        );
                        $templateCache.put(
                            'formio/components/password.html',
                            passwordTmpl);

                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/password/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option property="placeholder"></form-builder-option>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/phoneNumber/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option property="placeholder"></form-builder-option>' +
                        ...
                        $templateCache.put(
                            'formio/components/phoneNumber/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
                            '<form-builder-option property="unique"></form-builder-option>' +
                            '<form-builder-option property="validate.customMessage"></form-builder-option>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        ...
                        // Create the API markup.
                        $templateCache.put(
                            'formio/components/radio/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
                            '<form-builder-option property="validate.customMessage"></form-builder-option>' +
                            '<form-builder-option-custom-validation></form-builder-option-custom-validation>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/resource/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option property="placeholder"></form-builder-option>' +
                        ...
                        // Create the API markup.
                        $templateCache.put(
                            'formio/components/resource/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
                            '<form-builder-option property="validate.customMessage"></form-builder-option>' +
                            '</ng-form>'
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/select/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option property="placeholder"></form-builder-option>' +
                        ...
                        $templateCache.put(
                            'formio/components/select/data.html',
                            '<ng-form>' +
                            '<div class="form-group">' +
                            '<label for="dataSrc" form-builder-tooltip="The source to use for the select data. Values lets you provide your own values and labels. JSON lets you provide raw JSON data. URL lets you provide a URL to retrieve the JSON data from.">{{\'Data Source Type\' | formioTranslate}}</label>' +
                            '<select class="form-control" id="dataSrc" name="dataSrc" ng-model="component.dataSrc" ng-options="value as label | formioTranslate for (value, label) in dataSources"></select>' +
                        ...
                        // Create the API markup.
                        $templateCache.put(
                            'formio/components/select/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/selectboxes/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option-options-label-position></form-builder-option-options-label-position>' +
                        ...
                        // Create the API markup.
                        $templateCache.put(
                            'formio/components/selectboxes/api.html',
                            '<ng-form>' +
                            '<form-builder-option-key></form-builder-option-key>' +
                            '</ng-form>'
                        );
                        ...
                        // Create the API markup.
                        $templateCache.put(
                            'formio/components/selectboxes/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
                            '<form-builder-option property="validate.customMessage"></form-builder-option>' +
                            '<form-builder-option-custom-validation></form-builder-option-custom-validation>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/signature/display.html',
                            '<ng-form>' +
                        ...
                        // Create the Validation markup.
                        $templateCache.put(
                            'formio/components/signature/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
                            '<form-builder-option property="validate.customMessage"></form-builder-option>' +
                            '</ng-form>'
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/survey/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option property="tooltip"></form-builder-option>' +
                        ...
                        // Create the API markup.
                        $templateCache.put(
                            'formio/components/survey/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
                            '<form-builder-option property="validate.customMessage"></form-builder-option>' +
                            '<form-builder-option-custom-validation></form-builder-option-custom-validation>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        ...
                        tableClasses +=
                            "'table-hover': component.hover, ";
                        tableClasses +=
                            "'table-condensed': component.condensed}";
                        $templateCache.put(
                            'formio/formbuilder/table.html',
                            '<div class="table-responsive">' +
                            '<table ng-class="' + tableClasses +
                            '" class="table">' +
                        ...
                        $templateCache.put(
                            'formio/components/table/display.html',
                            '<ng-form>' +
        ...
        282: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                ...
                app.controller('wysiwygSettings', ['$scope', function(
                    $scope) {
                    $scope.wysiwygEnabled = !!$scope.component.wysiwyg;
                    $scope.wysiwygSettings = $scope.wysiwygEnabled &&
                        typeof($scope.component.wysiwyg) ==
                        "object" ? $scope.component.wysiwyg : {
                            toolbarGroups: [{
                                    name: 'basicstyles',
                                    groups: ['basicstyles',
                                        'cleanup'
                    ...
                    $scope.$watch('wysiwygEnabled', function(
                        value) {
                        $scope.component.wysiwyg =
                            value ? $scope.wysiwygSettings :
                            false;
                    });
                    $scope.$watch('wysiwygSettings', function(
                        value) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/textarea/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option property="placeholder"></form-builder-option>' +
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        // Create the settings markup.
                        $templateCache.put(
                            'formio/components/textfield/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="label"></form-builder-option>' +
                            '<form-builder-option-label-position></form-builder-option-label-position>' +
                            '<form-builder-option property="placeholder"></form-builder-option>' +
                        ...
                        $templateCache.put(
                            'formio/components/textfield/validate.html',
                            '<ng-form>' +
                            '<form-builder-option property="validate.required"></form-builder-option>' +
                            '<form-builder-option property="unique"></form-builder-option>' +
                            '<form-builder-option property="validate.minLength"></form-builder-option>' +
                    ...
                    function(formioComponentsProvider) {
                        ...
                        _each(views, function(view) {
                            if (view.name === 'Display') {
                                view.template =
                                    'formio/components/time/display.html';
                            }
                        });
        ...
        285: [function(_dereq_, module, exports) {
            ...
            module.exports = function(app) {
                ...
                app.run([
                    ...
                    function($templateCache) {
                        $templateCache.put(
                            'formio/formbuilder/well.html',
                            '<div class="well">' +
                            '<form-builder-list component="component" form="form" options="options" formio="::formio"></form-builder-list>' +
                            '</div>'
                        );
                        $templateCache.put(
                            'formio/components/well/display.html',
                            '<ng-form>' +
                            '<form-builder-option property="customClass"></form-builder-option>' +
                            '<form-builder-option property="tableView"></form-builder-option>' +
                            '<ng-form>'
        ...
        288: [function(_dereq_, module, exports) {
                ...
                return {
                    ...
                    controller: [
                        ...
                        function(
                            ...
                            var submitButton = angular.copy(
                                formioComponents.components.button
                                .settings);
                            if (!$scope.form) {
                                $scope.form = {};
                            }
                            ...
                            if (!$scope.options.noSubmit && !$scope
                                .form.components.length) {
                                $scope.form.components.push(
                                    submitButton);
                            }
                            $scope.hideCount = 2;
                            $scope.form.page = 0;
                            var baseUrl = $scope.options.baseUrl ||
                                Formio.getBaseUrl();
                            var formSrc = $scope.url || $scope.src ||
                                Formio.getProjectUrl();
                            $scope.formio = new Formio(formSrc, {
                                base: baseUrl
                            });
                            ...
                            var setNumPages = function() {
                                ...
                                if ((numPages > 0) && ($scope.form
                                        .page >= numPages)) {
                                    $scope.form.page = numPages -
                                        1;
                                }
                            };

                            // Load the form.
                            if ($scope.src && $scope.formio &&
                                $scope.formio.formId) {
                                $scope.formio.loadForm().then(
                                    function(form) {
                                        $scope.form = form;
                                        if (!$scope.form.display) {
                                            $scope.form.display =
                            ...
                            $scope.$watch('form.page', function(
                                page) {
                                if (page === undefined) {
                                    $scope.showPage(0);
                                }
                            ...
                            $scope.$watch('form.display', function(
                                display) {
                                $scope.hideCount = (display ===
                                    'wizard') ? 1 : 2;
                            });
                            ...
                            $scope.getPage = function() {
                                var pageNum = 0;
                                for (var i = 0; i < $scope.form
                                    .components.length; i++) {
                                    var component = $scope.form
                                        .components[i];
                                    if (component.type ===
                                        'panel') {
                            ...
                            $scope.formComponents = _cloneDeep(
                                formioComponents.components);
                            _each($scope.formComponents, function(
                                component, key) {
                                component.settings.isNew =
                                    true;
                                if (component.settings.hasOwnProperty(
                                        'builder') && !
                                    component.settings.builder ||
                                    component.disabled) {
                                    delete $scope.formComponents[
                                        key];
                                }
                            });
                            ...
                            $scope.formComponentGroups = _cloneDeep(
                                _omitBy(formioComponents.groups,
                                    'disabled'));
                            if ($scope.formComponentGroups) {
                                var copy = {};
                                angular.copy($scope.formComponentGroups,
                                    copy);
                                $scope.formComponentGroups = {};
                                $scope.formComponentGroups.layout =
                                    copy.layout;
                                $scope.formComponentGroups[
                                    "__component"] = copy[
                                    "__component"];
                                $scope.formComponentGroups.advanced =
                                    copy.advanced;
                            }
                            $scope.formComponentsByGroup = _groupBy(
                            ...
                            var resourceEnabled = !formioComponents
                                .groups.resource || !
                                formioComponents.groups.resource.disabled;
                            if ($scope.formio && resourceEnabled) {
                                $scope.formComponentsByGroup.resource = {};
                                $scope.formComponentGroups.resource = {
                                    title: $scope.options.resourceTitle ||
                                ...
                                if ($scope.options && $scope.options
                                    .resourceFilter) {
                                    query.params.tags = $scope.options
                                        .resourceFilter;
                                }

                                $scope.formio.loadForms(query).then(
                                    function(resources) {
                            ...
                            var rootlistEL = angular.element(
                                '.rootlist');
                            var formbuilderEL = angular.element(
                                '.formbuilder');

                            $interval(function setRootListHeight() {
                                var listHeight = rootlistEL
                                    .height('inherit').height();
                                var builderHeight =
                                    formbuilderEL.height();
                                if ((builderHeight -
                                        listHeight) > 100) {
                                    rootlistEL.height(
                                        builderHeight);
                    ...
                    link: function(scope, element) {
                        var scrollSidebar = debounce(function() {
                            ...
                            angular.element('.formbuilder')
                                .find('button').attr(
                                    'disabled', 'disabled');

                            // Make the left column follow the form.
                            var formComponents = angular.element(
                                '.formcomponents');
                            var formBuilder = angular.element(
                                '.formbuilder');
                            if (formComponents.length !==
                                0 && formBuilder.length !==
                                0) {
                                var maxScroll = formBuilder
                                    .outerHeight() >
                                    formComponents.outerHeight() ?
                                    formBuilder.outerHeight() -
                                    formComponents.outerHeight() :
                                    0;
                                // 50 pixels gives space for the fixed header.
                                var scroll = angular.element(
                                        window).scrollTop() -
                                    formComponents.parent()
                                    .offset().top + 50;
                                if (scroll < 0) {
                                    scroll = 0;
                                }
            ...
            "lodash/capitalize": 194,
            "lodash/cloneDeep": 197,
            "lodash/each": 201,
            "lodash/groupBy": 206,
            "lodash/merge": 229,
            "lodash/omitBy": 231,
            "lodash/upperFirst": 247
        }],
                    ...
                    return {
                        ...
                        controller: [
                            ...
                            function(
                                ...
                                $scope.component.conditional = $scope.component
                                    .conditional || {};
                                ...
                                $scope._components = _get($scope,
                                    'form.components') || [];
                                $scope._components = utils.flattenComponents(
                                    $scope._components);
                                ...
                                $scope._components = _reject($scope._components,
                                    function(c) {
                                        return !c.input || (c.type ===
                                            'button') || (c.key ===
                                            $scope.component.key
                                        ) || (!c.label && !c.key);
                                    });
                                ...
                                $scope.component.conditional.show =
                                    $scope.component.conditional.show ||
                                    '';
                                ...
                                $scope.component.conditional.show =
                                    _booleanMap.hasOwnProperty($scope.component
                                        .conditional.show) ?
                                    _booleanMap[$scope.component.conditional
                                        .show] :
                                    '';

                                // Default and watch the when logic.
                                $scope.component.conditional.when =
                                    $scope.component.conditional.when ||
                                    null;

                                // Default and watch the search logic.
                                $scope.component.conditional.eq =
                                    $scope.component.conditional.eq ||
                                    '';
        ...
        291: [function(_dereq_, module, exports) {
            ...
            module.exports = [
                ...
                function(
                    ...
                    $scope.hideCount = (_isNumber($scope.hideDndBoxCount) ?
                        $scope.hideDndBoxCount : 1);
                    $scope.$watch('hideDndBoxCount', function(hideCount) {
                        $scope.hideCount = hideCount ? hideCount :
                            1;
                    });
                    ...
                    $scope.$on('iframe-componentClick', function(event,
                        data) {
                        FormioUtils.eachComponent($scope.component.components,
                            function(component) {
                    ...
                    $scope.$on('iframe-componentUpdate', function(event,
                        data) {
                        FormioUtils.eachComponent($scope.component.components,
                            function(component) {
                                if (component.id === data.id) {
                    ...
                    $scope.$on('fbDragDrop', function(event, component) {
                        component.settings.id = Math.random().toString(
                            36).substring(7);
                    ...
                    $scope.addComponent = function(component, index) {
                        ...
                        if (parent.type !== 'form' && parent.type !==
                            'resource' && component.isNew) {
                            $scope.parentKey = parent.key;
                            component.key = $scope.parentKey +
                                _upperFirst(component.key);
                        } else {
                            $scope.parentKey = '';
                        }
                        ...
                        if (component.isNew && !component.lockConfiguration &&
                            (!component.key || (component.key.indexOf(
                                '.') === -1))) {
                            component.key += Date.now();
                            $scope.editComponent(component, index);
                        } else {
                            // Ensure the component has a key.
                            component.key = component.key || component.label ||
                                'component';

                            BuilderUtils.uniquify($scope.form,
                                component);

                            // Update the component to not be flagged as new anymore.
                            FormioUtils.eachComponent([component],
                                function(child) {
                                    delete child.isNew;
                                }, true);
                        }
                        ...
                        if ($scope.component.display === 'wizard') {
                            $scope.$apply(function() {
                                var pageIndex = (index === 0) ?
                                    0 : $scope.form.components[
                                        $scope.form.page].components
                                    .length;
                                $scope.form.components[$scope.form
                                    .page].components.splice(
                                    pageIndex, 0, component
                                );
                            });
                            return true;
                        }
                        ...
                        var lastComponent = $scope.component.components[
                            $scope.component.components.length - 1];
                        if (
                            (lastComponent) &&
                            ...
                            if ($scope.component.components.length ===
                                1) {
                                index = 0;
                            } else if (index >= $scope.component.components
                                .length) {
                                index -= 1;
                            }
                        }
                        ...
                        $scope.component.components.splice(index, 0,
                            component);
                    ...
                    var remove = function(component, isMoved) {
                        if ($scope.component.components.indexOf(
                                component) !== -1) {
                            var keptComponents;
                            if (!isMoved) {
                                function getKeptComponents(component) {
                                    var kept = [];
                                    var field;
                                    ...
                                    if (!field || !Array.isArray(
                                            component[field])) {
                                        return kept;
                                    }
                                    var subComponents = component[field];

                                    function retainComps(subComponents) {
                                        var kept = [];
                                        subComponents.forEach(function(
                                            subComponent) {
                                            if (subComponent.disableRemove) {
                                                kept.push(
                                                    subComponent
                                                );
                                            } else if (
                                    ...
                                    if (subComponents.some(Array.isArray)) {
                                        subComponents.forEach(function(
                                            subComponent) {
                                            kept = kept.concat(
                                                retainComps(
                                        ...
                                        kept = kept.concat(retainComps(
                                            subComponents));
                                    }
                                    return kept;
                                }
                                keptComponents = getKeptComponents(
                                    component);
                            }
                            $scope.component.components.splice($scope.component
                                .components.indexOf(component), 1);
                            if (keptComponents) {
                                keptComponents.reverse().forEach(
                    ...
                    $scope.removeComponent = function(component,
                        ...
                        if (shouldConfirm) {
                            ...
                            remove(component, isMoved);
                        }
                    };

                    // Edit a specific component.
                    $scope.editComponent = function(component, index) {
                        $scope.emit('startEdit', component);
                        index = index || 0;
                        $scope.formComponent = formioComponents.components[
                                component.type] || formioComponents.components
                            .custom;
                        // No edit view available
                        if (!$scope.formComponent.hasOwnProperty(
                                'views')) {
                            return;
                        }
                        ...
                        ngDialog.open({
                            ...
                            controller: ['$scope', 'Formio',
                                ...
                                function($scope, Formio,
                                    ...
                                    if ($scope.formComponent &&
                                        $scope.formComponent
                                        .onEdit) {
                                        $controller($scope.formComponent
                                            .onEdit, {
                                                $scope: $scope
                                            });
                                    }
                            ...
                            var cancelled = e.value === false ||
                                e.value === '$closeButton' || e
                                .value === '$document' || e.value ===
                                '$escape';
                            if (cancelled) {
                                if (component.isNew) {
                    ...
                    $scope.cloneComponent = function(component) {
                        ...
                        var container;
                        if ($scope.$parent.component && $scope.$parent.component
                            .type === 'columns') {
                            var column = _.find($scope.$parent.component
                                .columns,
                                function(column) {
                                    return _.find(column.components, {
                    ...
                    $scope.copyComponent = function(component) {
                        window.sessionStorage.setItem(
                            'componentClipboard', JSON.stringify(
                    ...
                    $scope.pasteComponent = function() {
                        var component;
                        try {
                            component = JSON.parse(window.sessionStorage
                                .getItem('componentClipboard'));
                        } catch (e) {
                            console.log(
                                'Error fetching componentClipboard'
                            );
                        }
                        ...
                        controller: [
                            ...
                            function(
                                ...
                                $scope.formComponent =
                                    ...
                                    .custom;
                                if ($scope.formComponent &&
                                    $scope.formComponent.fbtemplate
                                ) {
                                    $scope.template = $scope.formComponent
                                        .fbtemplate;
                                }
                            }
                        ]
        ...
        294: [function(_dereq_, module, exports) {
             ...
             */
            module.exports = ['COMMON_OPTIONS', '$filter', function(
                COMMON_OPTIONS, $filter) {
                return {
                    restrict: 'E',
                    require: 'property',
                    priority: 2,
                    ...
                    template: function(el, attrs) {
                        var formioTranslate = $filter(
                            'formioTranslate');

                        var property = attrs.property;
                        if (!COMMON_OPTIONS[property]) {
                            return '<i for="nada"></i>';
                        }
                        var label = attrs.label || (COMMON_OPTIONS[
                            property] && COMMON_OPTIONS[
                            property].label) || '';
                        var placeholder = attrs.placeholder || (
                            COMMON_OPTIONS[property] &&
                            COMMON_OPTIONS[property].placeholder
                        ) || null;
                        var type = attrs.type || (COMMON_OPTIONS[
                            property] && COMMON_OPTIONS[
                            property].type) || 'text';
                        var tooltip = attrs.tooltip || (
                                COMMON_OPTIONS[property] &&
                                COMMON_OPTIONS[property].tooltip) ||
                            '';

                        var input = type === 'textarea' ? angular.element(
                            '<textarea></textarea>') : angular.element(
                            '<input>');
                        var inputAttrs = {
                            id: property,
                            name: property,
                        ...
                        if (inputAttrs.type && inputAttrs.type.toLowerCase() ===
                            'checkbox') {
                            return '<div class="checkbox">' +
                                '<label for="' + property +
                                '" form-builder-tooltip="' +
                                formioTranslate(tooltip) + '">' +
                ...
                return {
                    ...
                    controller: ['$scope', function($scope) {
                        ...
                        if (!$scope.component.inputsLabelPosition) {
                            $scope.component.inputsLabelPosition =
                                'top';
                        }
                    }]
                };
        ...
        297: [function(_dereq_, module, exports) {
            ...
            module.exports = function() {
                return {
                    ...
                    controller: ['$scope', 'BuilderUtils', function($scope,
                        BuilderUtils) {
                        ...
                        $scope.onBlur = function() {
                            ...
                            if (!$scope.component.key && $scope
                                .formComponents[$scope.component
                                    .type].settings.key) {
                                $scope.component.key = $scope.formComponents[
                                        $scope.component.type].settings
                                    .key;
                                $scope.component.lockKey =
                                    false; // Also unlock key
                                BuilderUtils.uniquify($scope.form,
                                    $scope.component);
                            }
                        };
                        ...
                        $scope.shouldWarnAboutEmbedding = function() {
                            ...
                            return !$scope.component.source &&
                                $scope.component.key.indexOf(
                                    '.') !== -1;
                        };
                    }]
                };
                ...
                return {
                    ...
                    controller: ['$scope', function($scope) {
                        ...
                        if (!$scope.component.optionsLabelPosition) {
                            $scope.component.optionsLabelPosition =
                                'right';
                        }
                    }]
                };
        ...
        300: [function(_dereq_, module, exports) {
            ...
            module.exports = function() {
                return {
                    ...
                    controller: ['$scope', 'BuilderUtils', function($scope,
                        BuilderUtils) {
                        $scope.shortcuts = BuilderUtils.getAvailableShortcuts(
                            $scope.form, $scope.component);
                    }]
                };
            };
            ...
            module.exports = function() {
                return {
                    ...
                    controller: ['$scope', function($scope) {
                        ...
                        $scope.tags = _map($scope.component.tags,
                            function(tag) {
                                return {
                                    text: tag
                                };
                        ...
                        $scope.removeTag = function(tag) {
                            if ($scope.component.tags && $scope
                                .component.tags.length) {
                                var tagIndex = $scope.component
                                    .tags.indexOf(tag.text);
                                if (tagIndex !== -1) {
                                    $scope.component.tags.splice(
                                        tagIndex, 1);
                                }
                            }
                        };
                    ...
                    controller: [
                        ...
                        function($scope) {
                            ...
                            var changeTable = function() {
                                /*eslint-disable max-depth */
                                if ($scope.component.numRows &&
                                    $scope.component.numCols) {
                                    var tmpTable = [];
                                    $scope.component.rows.splice(
                                        $scope.component.numRows
                                    );
                                    for (var row = 0; row < $scope.component
                                        .numRows; row++) {
                                        if ($scope.component.rows[
                                                row]) {
                                            $scope.component.rows[
                                                row].splice(
                                                $scope.component
                                                .numCols);
                                        }
                                        for (var col = 0; col <
                                            $scope.component.numCols; col++
                                        ) {
                                            if (!tmpTable[row]) {
                                                tmpTable[row] = [];
                                            }
                                    ...
                                    $scope.component.rows = _merge(
                                        tmpTable, $scope.component
                                        .rows);
                                    /*eslint-enable max-depth */
                                }
                            };

                            $scope.$watch('component.numRows',
                                changeTable);
                            $scope.$watch('component.numCols',
                                changeTable);
                        }
                    ]
                };
                    ...
                    link: function($scope, el, attrs) {
                        ...
                        if (attrs.formBuilderTooltip || attrs.title) {
                            ...
                            tooltip.popover({
                                ...
                                trigger: 'manual',
                                placement: 'right',
                                content: formioTranslate(
                                    attrs.title ||
                                    attrs.formBuilderTooltip
                                )
                            }).on('mouseenter', function() {
                                var $self = angular.element(
                                    this);
                                $self.popover('show');
                                $self.siblings('.popover').on(
                                    'mouseleave',
                                    function() {
                                        $self.popover(
                                            'hide');
        ...
        308: [function(_dereq_, module, exports) {
            ...
            module.exports = function() {
                return {
                    ...
                    replace: true,
                    link: function($scope, el, attrs) {
                        $scope.valueProperty = $scope.valueProperty ||
                            'value';
                        $scope.labelProperty = $scope.labelProperty ||
                            'label';
                        $scope.valueLabel = $scope.valueLabel ||
                            'Value';
                        $scope.labelLabel = $scope.labelLabel ||
                            'Label';
                        $scope.data = $scope.data || [];
                        ...
                        if (!attrs.noAutocompleteValue) {
                            $scope.$watch('data', function(newValue,
                                ...
                                _map(newValue, function(entry,
                                    i) {
                                    if (entry[$scope.labelProperty] !==
                                        oldValue[i][
                                            $scope.labelProperty
                                        ]) { // label changed
                                        if (entry[
        ...
        309: [function(_dereq_, module, exports) {
            ...
            var _without = _dereq_('lodash/without');
            var _map = _dereq_('lodash/map');
            var _camelCase = _dereq_('lodash/camelCase');
            module.exports = ['BuilderUtils', function(BuilderUtils) {
                return {
                    ...
                    link: function($scope, el, attrs) {
                        ...
                        var shortcuts = BuilderUtils.getAvailableShortcuts(
                            $scope.form, $scope.component);
                        $scope.shortcuts = [];
                        ...
                        function updateShortcuts(entries) {
                            ...
                            entries.forEach(function(entry) {
                                if (entry.shortcut) {
                                    bindedShortcuts.push(
                                        entry.shortcut);
                                }
                            });
                            $scope.shortcuts = entries.map(function(
                                entry) {
                                var shortcutsToOmit =
                                    _without(
                                        bindedShortcuts,
        ...
        310: [function(_dereq_, module, exports) {
            ...
            module.exports = ['FormioUtils', function(FormioUtils) {
                ...
                var findExistingComponents = function(components, input) {
                    ...
                    FormioUtils.eachComponent(components, function(
                        component) {
                        ...
                        if (
                            ...
                            existingComponents[component.key] =
                                component;
                        }
                    }, true);
                ...
                var uniquify = function(form, component) {
                    ...
                    FormioUtils.eachComponent([component], function(
                        component) {
                        ...
                        var memoization =
                            findExistingComponents(form.components,
                                component);
                        while (keyExists(memoization,
                                component.key)) {
                            component.key = iterateKey(
                                component.key);
                        }
                    }, true);
                ...
                function getAlphaShortcuts() {
                    return _range('A'.charCodeAt(), 'Z'.charCodeAt() +
                        1).map(function(charCode) {
                ...
                function getBindedShortcuts(components, input) {
                    ...
                    FormioUtils.eachComponent(components, function(
                        ...
                        if (component.values) {
                            component.values.forEach(function(
                                value) {
                                if (value.shortcut) {
                ...
                function getAvailableShortcuts(form, component) {
                    return _difference(
                        getAlphaShortcuts().concat(
                            getAdditionalShortcuts(component.type)),
                        getBindedShortcuts(form.components,
                            component));
                }
        ...
        312: [function(_dereq_, module, exports) {
            "use strict";
            /*! ng-formio-builder v2.25.2 | https://unpkg.com/ng-formio-builder@2.25.2/LICENSE.txt */
                ...
                return {
                    ...
                    link: function(scope, element) {
                        ...
                        el.addEventListener('drop', function(event) {
                            ...
                            var dragData = JSON.parse(event
                                .dataTransfer.getData(
                                    'text/plain'));
                            var dropOffset = jQuery(el).offset();
                            el.style.zIndex = 0;
                            dragData.fbDropX = event.pageX -
                                dropOffset.left;
                            dragData.fbDropY = event.pageY -
                                dropOffset.top;
                            scope.$emit('fbDragDrop',
                                dragData);
                            return false;
                        }, false);
                    }
            ...
            app.directive('formBuilderComponent', _dereq_(
                './directives/formBuilderComponent'));

            app.directive('formBuilderElement', _dereq_(
                './directives/formBuilderElement'));

            app.controller('formBuilderDnd', _dereq_(
                './directives/formBuilderDnd'));

            app.directive('formBuilderList', _dereq_(
                './directives/formBuilderList'));

            app.directive('formBuilderRow', _dereq_(
                './directives/formBuilderRow'));

            app.directive('jsonInput', _dereq_('./directives/jsonInput'));

            app.directive('formBuilderOption', _dereq_(
                './directives/formBuilderOption'));

            app.directive('formBuilderTable', _dereq_(
                './directives/formBuilderTable'));

            app.directive('formBuilderOptionInputsLabelPosition', _dereq_(
                './directives/formBuilderOptionInputsLabelPosition'));

            app.directive('formBuilderOptionKey', _dereq_(
                './directives/formBuilderOptionKey'));

            app.directive('formBuilderOptionLabelPosition', _dereq_(
                './directives/formBuilderOptionLabelPosition'));

            app.directive('formBuilderOptionOptionsLabelPosition', _dereq_(
                './directives/formBuilderOptionOptionsLabelPosition'));

            app.directive('formBuilderOptionShortcut', _dereq_(
                './directives/formBuilderOptionShortcut'));

            app.directive('formBuilderOptionTags', _dereq_(
                './directives/formBuilderOptionTags'));

            app.directive('validApiKey', _dereq_('./directives/validApiKey'));

            app.directive('formBuilderOptionCustomValidation', _dereq_(
                './directives/formBuilderOptionCustomValidation'));

            app.directive('formBuilderTooltip', _dereq_(
                './directives/formBuilderTooltip'));

            app.directive('valueBuilder', _dereq_('./directives/valueBuilder'));

            app.directive('valueBuilderWithShortcuts', _dereq_(
                './directives/valueBuilderWithShortcuts'));

            app.directive('objectBuilder', _dereq_('./directives/objectBuilder'));

            app.directive('formBuilderConditional', _dereq_(
                './directives/formBuilderConditional'));
            ...
            app.run([
                ...
                function(
                    ...
                    $templateCache.put(
                        'formio/formbuilder/editbuttons.html',
                        "<div class=\"component-btn-group\">\n  <div class=\"btn btn-xxs btn-danger component-settings-button component-settings-button-remove\" style=\"z-index: 1000\" ng-if=\"!component.disableRemove\" ng-click=\"removeComponent(component, formComponent.confirmRemove)\"><span class=\"glyphicon glyphicon-remove\"></span></div>\n  <div ng-if=\"::formComponent.views && !component.lockConfiguration && !component.disableClone\" class=\"btn btn-xxs btn-default component-settings-button component-settings-button-clone\" style=\"z-index: 1000\" ng-click=\"cloneComponent(component)\"><span class=\"glyphicon glyphicon-new-window\"></span></div>\n  <div ng-if=\"::!hideMoveButton\" class=\"btn btn-xxs btn-default component-settings-button component-settings-button-move\" style=\"z-index: 1000\"><span class=\"glyphicon glyphicon glyphicon-move\"></span></div>\n  <div ng-if=\"::formComponent.views && !component.lockConfiguration\" class=\"btn btn-xxs btn-default component-settings-button component-settings-button-edit\" style=\"z-index: 1000\" ng-click=\"editComponent(component, $index)\"><span class=\"glyphicon glyphicon-cog\"></span></div>\n</div>\n"
                    );

                    $templateCache.put(
                        'formio/formbuilder/component.html',
                    ...
                    $templateCache.put(
                        'formio/components/confirm-remove.html',
            ...
            "./components": 269,
            "./constants/commonOptions": 286,
            "./constants/formOptions": 287,
            "./directives/formBuilder": 288,
            "./directives/formBuilderComponent": 289,
            "./directives/formBuilderConditional": 290,
            "./directives/formBuilderDnd": 291,
            "./directives/formBuilderElement": 292,
            "./directives/formBuilderList": 293,
            "./directives/formBuilderOption": 294,
            "./directives/formBuilderOptionCustomValidation": 295,
            "./directives/formBuilderOptionInputsLabelPosition": 296,
            "./directives/formBuilderOptionKey": 297,
            "./directives/formBuilderOptionLabelPosition": 298,
            "./directives/formBuilderOptionOptionsLabelPosition": 299,
            "./directives/formBuilderOptionShortcut": 300,
            "./directives/formBuilderOptionTags": 301,
            "./directives/formBuilderRow": 302,
            "./directives/formBuilderTable": 303,
            "./directives/formBuilderTooltip": 304,
            "./directives/jsonInput": 305,
            "./directives/objectBuilder": 306,
            "./directives/validApiKey": 307,
            "./directives/valueBuilder": 308,
            "./directives/valueBuilderWithShortcuts": 309,
            "./factories/BuilderUtils": 310,
            "./factories/debounce": 311
        }]
    }, {}, [312])(312)
});
