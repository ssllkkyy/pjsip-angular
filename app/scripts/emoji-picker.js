angular.module('templates-dist', ['templates/emoji-button-bootstrap.html',
    'templates/emoji-button-strap.html', 'templates/emoji-button.html',
    'templates/emoji-popover-bootstrap.html', 'templates/emoji-popover-strap.html',
    'templates/emoji-popover.html'
]);

angular.module("templates/emoji-button-bootstrap.html", []).run(["$templateCache", function(
    $templateCache) {
...
angular.module("templates/emoji-button-strap.html", []).run(["$templateCache", function(
    $templateCache) {
...
angular.module("templates/emoji-popover-bootstrap.html", []).run(["$templateCache", function(
    $templateCache) {
...
angular.module("templates/emoji-popover-strap.html", []).run(["$templateCache", function(
    $templateCache) {
...
angular.module('vkEmojiPicker').constant('EmojiGroups', (function() {
    ...
    var life = ['bamboo', 'gift_heart', 'dolls', 'school_satchel', 'mortar_board',
        'flags',
    ...
    var travel = ['house', 'house_with_garden', 'school', 'office', 'post_office',
        'hospital',
...
angular.module('vkEmojiPicker').directive('emojiPicker', [
    'EmojiGroups', 'vkEmojiStorage', 'vkEmojiTransforms',
        ...
        return {
            ...
            link: function($scope, element, attrs) {
                ...
                function fireOnChangeFunc() {
                    if ($scope.onChangeFunc && typeof $scope.onChangeFunc ===
                        'function') {
...
angular.module('vkEmojiPicker').filter('capitalize', function() {
    ...
    this.$get = [
        ...
        function($rootScope, $http, $sce, $templateCache, $compile) {
            function EmojiPopover(element, config) {
                ...
                var scope = $popover.$scope = options.scope && options.scope.$new() ||
                    $rootScope.$new();
                ...
                var applyPlacement = function(parentElement, popoverElement) {
                    ...
                    var offset = getPopoverOffset(options.placement, clientRect,
                ...
                var getPopoverOffset = function(placement, position, popoverWidth,
                    popoverHeight) {
                    var offset;
                    ...
                    switch (placement) {
                        case 'right':
                            offset = {
                                //top: position.top - popoverHeight - 120,
                                top: -240,
                                left: position.right - popoverWidth - 50 -
                                    bodyRect.width * 0.25
                            };
                            break;
                        case 'bottom':
                        ...
                        default:
                            offset = {
                                top: position.top - popoverHeight - position.height *
                                    3,
                                left: position.left
                            };
                ...
                scope.showEmojiName = function(emoji) {
                    return emoji.replace(/_/g, ' ');
                };

                scope.showCatName = function(emoji) {
                ...
                $popover.show = function() {
                    ...
                    popoverElement = popoverLinker(popoverScope, function(
                        clonedElement, scope) {});
...
angular.module('vkEmojiPicker').factory('vkEmojiStorage', [
    '$window', 'vkEmojiLocalStorage',
    function($window, emojiStorage) {
        var factory = {};
...
angular.module('vkEmojiPicker').factory('vkEmojiTransforms', [
    'EmojiHex', 'EmojiGroups',
    function(EmojiHex, EmojiGroups) {
        var transforms = {
            hexify: hexify,
            imagify: imagify,
            unicodify: unicodify,
        ...
        function imagify(input) {
            ...
            return input.replace(regex, function(match, text) {
                ...
                var output = ['<i class="emoji-picker emoji-', className, '" alt="',
                    text, '" title=":', text, ':"></i>'
                ];
