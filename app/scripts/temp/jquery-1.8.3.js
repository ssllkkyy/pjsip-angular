...
(function(window, undefined) {
    ...
    jQuery.extend({
        ...
        isPlainObject: function(obj) {
            ...
            if (!obj || jQuery.type(obj) !== "object" || obj.nodeType || jQuery.isWindow(
                    obj)) {
                return false;
            }
        ...
        map: function(elems, callback, arg) {
            var value, key,
                ...
                isArray = elems instanceof jQuery || length !== undefined && typeof length ===
                "number" && ((length > 0 && elems[0] && elems[length - 1]) ||
    ...
    jQuery.each("Boolean Number String Function Array Date RegExp Object".split(" "), function(
        i, name) {
                    ...
                    then: function( /* fnDone, fnFail, fnProgress */ ) {
                        ...
                        return jQuery.Deferred(function(newDefer) {
                            jQuery.each(tuples, function(i, tuple) {
                                ...
                                deferred[tuple[1]](jQuery.isFunction(
                                        fn) ?
                                    function() {
    ...
    jQuery.extend({
        ...
        hasData: function(elem) {
            elem = elem.nodeType ? jQuery.cache[elem[jQuery.expando]] : elem[jQuery
                .expando];
    ...
    jQuery.extend({
            ...
            select: {
                get: function(elem) {
                    ...
                    for (; i < max; i++) {
                        ...
                        if ((option.selected || i === index) &&
                            ...
                            (!option.parentNode.disabled || !jQuery.nodeName(option
                                .parentNode, "optgroup"))) {
                ...
                set: function(elem, value) {
                    ...
                    jQuery(elem).find("option").each(function() {
                        this.selected = jQuery.inArray(jQuery(this).val(),
                            values) >= 0;
                    });
        ...
        attr: function(elem, name, value, pass) {
            ...
            if (value !== undefined) {
                ...
                } else if (hooks && "set" in hooks && notxml && (ret = hooks.set(
    ...
    jQuery.event = {
        ...
        trigger: function(event, data, elem, onlyHandlers) {
            ...
            for (i = 0; i < eventPath.length && !event.isPropagationStopped(); i++) {
                ...
                handle = (jQuery._data(cur, "events") || {})[event.type] && jQuery._data(
                    cur, "handle");
                if (handle) {
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
                ...
                if ((!special._default || special._default.apply(elem.ownerDocument,
                        data) === false) &&
                    !(type === "click" && jQuery.nodeName(elem, "a")) && jQuery.acceptData(
                        elem)) {
                    ...
                    if (rformElems.test(elem.nodeName) && !jQuery._data(elem,
                        ...
                        jQuery.event.add(elem, "change._change", function(event) {
                            if (this.parentNode && !event.isSimulated &&
                                !event.isTrigger) {
                                jQuery.event.simulate("change", this.parentNode,
                                    event, true);
                            }
                        });
        ...
        contains = Sizzle.contains = docElem.contains ?
            function(a, b) {
                var adown = a.nodeType === 9 ? a.documentElement : a,
                    bup = b && b.parentNode;
                return a === bup || !!(bup && bup.nodeType === 1 && adown.contains && adown
                    .contains(bup));
            } :
                ...
                "ID": assertGetIdNotName ?
                    function(id, context, xml) {
                        ...
                        if (typeof context.getElementById !== strundefined && !xml) {
                            ...
                            return m ?
                                m.id === id || typeof m.getAttributeNode !==
                                strundefined && m.getAttributeNode("id").value === id ? [m] :
                                undefined : [];
                        }
                    },
                ...
                "CHILD": function(match) {
                    ...
                    */
                    ...
                    if (match[1] === "nth") {
                        ...
                        match[3] = +(match[3] ? match[4] + (match[5] || 1) : 2 * (
                    ...
                    return pattern ||
                        ...
                        classCache(className, function(elem) {
                            return pattern.test(elem.className || (typeof elem.getAttribute !==
                                strundefined && elem.getAttribute(
                                    "class")) || "");
                        });
                },
                    ...
                    return function(elem, context) {
                        ...
                        return operator === "=" ? result === check :
                            ...
                            operator === "$=" ? check && result.substr(result.length -
                                check.length) === check :
                            operator === "~=" ? (" " + result + " ").indexOf(
                                check) > -1 :
                            operator === "|=" ? result === check || result.substr(
                        ...
                        while ((elem = elem[dir])) {
                            if (checkNonElements || elem.nodeType === 1) {
                                if ((cache = elem[expando]) === cachedkey) {
                                    return elem.sizset;
                                } else if (typeof cache === "string" && cache.indexOf(
                                        dirkey) === 0) {
                                    if (elem.sizset) {
                                        return elem;
                                    }
                ...
                if ((matcher = Expr.relative[tokens[i].type])) {
                    ...
                    if (matcher[expando]) {
                        ...
                        return setMatcher(
                            ...
                            i > 1 && tokens.slice(0, i - 1).join("").replace(rtrim,
                                "$1"),
                            matcher,
        ...
        function select(selector, context, results, seed, xml) {
            ...
            if (!seed) {
                ...
                if (match.length === 1) {
                    ...
                    for (i = matchExpr["POS"].test(selector) ? -1 : tokens.length - 1; i >=
                        0; i--) {
                        token = tokens[i];
            ...
            (function() {
                ...
                if (matches) {
                    ...
                    Sizzle.matchesSelector = function(elem, expr) {
                        ...
                        if (!isXML(elem) && !rbuggyMatches.test(expr) && !rbuggyQSA
                            .test(expr)) {
                            try {
    ...
    function findOrAppend(elem, tag) {
        return elem.getElementsByTagName(tag)[0] || elem.appendChild(elem.ownerDocument.createElement(
            tag));
    }
    ...
    jQuery.buildFragment = function(args, context, scripts) {
        ...
        if (args.length === 1 && typeof first === "string" && first.length < 512 && context ===
            document &&
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function(selector) {
            ...
            if ((parent == null || parent && parent.nodeType === 11 && parent.childNodes
                    .length === 1) && l === 1) {
    ...
    jQuery.extend({
        clone: function(elem, dataAndEvents, deepDataAndEvents) {
            ...
            if (jQuery.support.html5Clone || jQuery.isXMLDoc(elem) || !rnoshimcache
                .test("<" + elem.nodeName + ">")) {
            ...
            for (i = 0;
                ...
                if (typeof elem === "string") {
                    if (!rhtml.test(elem)) {
                        ...
                        if (!jQuery.support.leadingWhitespace && rleadingWhitespace
                            .test(elem)) {
                ...
                for (i = 0;
                    ...
                    if (!(jQuery.nodeName(elem, "script") && handleScript(elem))) {
                        ...
                        if (typeof elem.getElementsByTagName !== "undefined") {
                            ...
                            jsTags = jQuery.grep(jQuery.merge([], elem.getElementsByTagName(
                                "script")), handleScript);
    ...
    function getWidthOrHeight(elem, name, extra) {
        ...
        if (val <= 0 || val == null) {
            ...
            valueIsBorderBox = isBorderBox && (jQuery.support.boxSizingReliable || val === elem
                .style[name]);
        ...
        jQuery.cssHooks[name] = {
            get: function(elem, computed, extra) {
                if (computed) {
                    ...
                    if (elem.offsetWidth === 0 && rdisplayswap.test(curCSS(elem,
                            "display"))) {
    ...
    if (!jQuery.support.opacity) {
        jQuery.cssHooks.opacity = {
            get: function(elem, computed) {
                ...
                return ropacity.test((computed && elem.currentStyle ? elem.currentStyle
                ...
                jQuery.cssHooks[prop] = {
                    get: function(elem, computed) {
                        if (computed) {
                            ...
                            return rnumnonpx.test(ret) ? jQuery(elem).position()[
                                prop] + "px" : ret;
                        }
                    }
                };
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        if (elem.nodeType === 1 && ("height" in props || "width" in props)) {
            ...
            if (jQuery.css(elem, "display") === "inline" &&
                ...
                if (!jQuery.support.inlineBlockNeedsLayout || css_defaultDisplay(elem.nodeName) ===
                    "inline") {
    ...
    jQuery.speed = function(speed, easing, fn) {
        ...
        opt.duration = jQuery.fx.off ? 0 : typeof opt.duration === "number" ? opt.duration :
            opt.duration in jQuery.fx.speeds ? jQuery.fx.speeds[opt.duration] : jQuery.fx.speeds
            ._default;
