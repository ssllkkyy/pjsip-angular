        ...
        scrollParent: function() {
            ...
            if (($.ui.ie && (/(static|relative)/).test(this.css('position'))) || (
                ...
                scrollParent = this.parents().filter(function() {
                    return (/(relative|absolute|fixed)/).test($.css(this,
                        'position')) && (/(auto|scroll)/).test($.css(
                        this, 'overflow') + $.css(this,
                        'overflow-y') + $.css(this, 'overflow-x'));
                }).eq(0);
            } else {
                scrollParent = this.parents().filter(function() {
                    return (/(auto|scroll)/).test($.css(this, 'overflow') +
                        $.css(this, 'overflow-y') + $.css(this,
                            'overflow-x'));
                }).eq(0);
            }
    ...
    $.extend($.ui, {
        ...
        plugin: {
            ...
            call: function(instance, name, args) {
                ...
                if (!set || !instance.element[0].parentNode || instance.element[0].parentNode
                    .nodeType === 11) {
                    return;
                }
        ...
        _mouseDown: function(event) {
            ...
            var that = this,
                ...
                elIsCancel = (typeof this.options.cancel === "string" && event.target
                    .nodeName ? $(event.target).closest(this.options.cancel).length :
                    false);
    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _mouseStop: function(event) {
            ...
            if ((this.options.revert == "invalid" && !dropped) || (this.options.revert ==
                    "valid" && dropped) || this.options.revert === true || ($.isFunction(
                    this.options.revert) && this.options.revert.call(this.element,
                    dropped))) {
                var that = this;
                $(this.helper).animate(this.originalPosition, parseInt(this.options
        ...
        _getHandle: function(event) {
            ...
            var handle = !this.options.handle || !$(this.options.handle, this.element)
                .length ? true : false;
        ...
        _createHelper: function(event) {
            ...
            var helper = $.isFunction(o.helper) ? $(o.helper.apply(this.element[0],
                [event])) : (o.helper == 'clone' ? this.element.clone().removeAttr(
                'id') : this.element);
            ...
            if (helper[0] != this.element[0] && !(/(fixed|absolute)/).test(helper.css(
                    "position")))
        ...
        _getRelativeOffset: function() {
            ...
            if (this.cssPosition == "relative") {
                ...
                return {
                    top: p.top - (parseInt(this.helper.css("top"), 10) || 0) + this
        ...
        _setContainment: function() {
            ...
            if (o.containment == 'document' || o.containment == 'window') this.containment = [
                o.containment == 'document' ? 0 : $(window).scrollLeft() - this
                .offset.relative.left - this.offset.parent.left,
                o.containment == 'document' ? 0 : $(window).scrollTop() - this.offset
            ...
            if (!(/^(document|window|parent)$/).test(o.containment) && o.containment
                .constructor != Array) {
                var c = $(o.containment);
                var ce = c[0];
                if (!ce) return;
                ...
                this.containment = [
                    ...
                    (parseInt($(ce).css("borderLeftWidth"), 10) || 0) - (
                        parseInt($(ce).css("paddingRight"), 10) || 0) - this.helperProportions
                    .width - this.margins.left - this.margins.right,
                    (over ? Math.max(ce.scrollHeight, ce.offsetHeight) : ce.offsetHeight) -
                    (parseInt($(ce).css("borderTopWidth"), 10) || 0) - (
                        parseInt($(ce).css("paddingBottom"), 10) || 0) - this.helperProportions
            ...
            var o = this.options,
                scroll = this.cssPosition == 'absolute' && !(this.scrollParent[0] !=
                    document && $.contains(this.scrollParent[0], this.offsetParent[
                        0])) ? this.offsetParent : this.scrollParent,
        ...
        _generatePosition: function(event) {
            ...
            if (this.originalPosition) { //If we are not dragging yet, we won't check for options
                ...
                if (this.containment) {
                    ...
                    if (event.pageX - this.offset.click.left < containment[0]) pageX =
                        containment[0] + this.offset.click.left;
                    if (event.pageY - this.offset.click.top < containment[1]) pageY =
                        containment[1] + this.offset.click.top;
                    if (event.pageX - this.offset.click.left > containment[2]) pageX =
                        containment[2] + this.offset.click.left;
                ...
                if (o.grid) {
                    ...
                    var top = o.grid[1] ? this.originalPageY + Math.round((pageY -
                    ...
                    pageY = containment ? (!(top - this.offset.click.top <
                        ...
                        containment[1]) ? top - o.grid[1] : top + o.grid[
                        1])) : top;

                    var left = o.grid[0] ? this.originalPageX + Math.round((pageX -
                        this.originalPageX) / o.grid[0]) * o.grid[0] : this.originalPageX;
        ...
        _clear: function() {
            ...
            if (this.helper[0] != this.element[0] && !this.cancelHelperRemoval) this
                .helper.remove();
        ...
        _trigger: function(type, event, ui) {
            ...
            if (type == "drag") this.positionAbs = this._convertPositionTo(
                "absolute"); //The absolute position has to be recalculated after plugins
        ...
        stop: function(event, ui) {
            ...
            $.each(inst.sortables, function() {
                if (this.instance.isOver) {
                    ...
                    if (this.shouldRevert) this.instance.options.revert =
                        true;
        ...
        drag: function(event, ui) {
            ...
            $.each(inst.sortables, function(i) {
                    ...
                    $.each(inst.sortables, function() {
                        ...
                        if (this != thisSortable &&
                            this.instance._intersectsWith(this.instance
                                .containerCache) &&
                            $.ui.contains(thisSortable.instance.element[
                ...
                if (innermostIntersecting) {
                    ...
                    if (this.instance.currentItem) this.instance._mouseDrag(
                        event);
                    ...
                    if (this.instance.isOver) {
                        ...
                        if (this.instance.placeholder) this.instance.placeholder
                            .remove();
            ...
            if (i.scrollParent[0] != document && i.scrollParent[0].tagName !=
                ...
                if (!o.axis || o.axis != 'y') {
                    if ((i.overflowOffset.left + i.scrollParent[0].offsetWidth) -
                        ...
                        i.scrollParent[0].scrollLeft = scrolled = i.scrollParent[0]
        ...
        drag: function(event, ui) {
            ...
            for (var i = inst.snapElements.length - 1; i >= 0; i--) {
                ...
                if (!((l - d < x1 && x1 < r + d && t - d < y1 && y1 < b + d) || (l -
                        d < x1 && x1 < r + d && t - d < y2 && y2 < b + d) || (l -
                        d < x2 && x2 < r + d && t - d < y1 && y1 < b + d) || (l -
                        d < x2 && x2 < r + d && t - d < y2 && y2 < b + d))) {
                    if (inst.snapElements[i].snapping)(inst.options.snap.release &&
                        inst.options.snap.release.call(inst.element, event, $.extend(
                            inst._uiHash(), {
    ...
    $.widget("ui.droppable", {
        ...
        _over: function(event) {
            ...
            if (!draggable || (draggable.currentItem || draggable.element)[0] ==
                this.element[0]) return; // Bail if draggable and droppable are same element
        ...
        _drop: function(event, custom) {
            ...
            if (!draggable || (draggable.currentItem || draggable.element)[0] ==
                this.element[0]) return false; // Bail if draggable and droppable are same element
            ...
            if (this.accept.call(this.element[0], (draggable.currentItem ||
                    draggable.element))) {
                if (this.options.activeClass) this.element.removeClass(this.options
                    .activeClass);
                if (this.options.hoverClass) this.element.removeClass(this.options.hoverClass);
    ...
    $.ui.intersect = function(draggable, droppable, toleranceMode) {
        ...
        switch (toleranceMode) {
            ...
            case 'intersect':
                ...
                break;
            case 'pointer':
                var draggableLeft = ((draggable.positionAbs || draggable.position.absolute)
                        .left + (draggable.clickOffset || draggable.offset.click).left),
                    draggableTop = ((draggable.positionAbs || draggable.position.absolute).top +
                        (draggable.clickOffset || draggable.offset.click).top),
                    isOver = $.ui.isOver(draggableTop, draggableLeft, t, l, droppable.proportions
                        .height, droppable.proportions.width);
                return isOver;
                break;
            case 'touch':
                return (
        ...
        prepareOffsets: function(t, event) {
            ...
            droppablesLoop: for (var i = 0; i < m.length; i++) {
                ...
                if (m[i].options.disabled || (t && !m[i].accept.call(m[i].element[0],
                        (t.currentItem || t.element)))) continue; //No disabled and non-accepted
        ...
        drag: function(draggable, event) {
            ...
            $.each($.ui.ddmanager.droppables[draggable.options.scope] || [], function() {
                ...
                if (this.options.greedy) {
                    ...
                    var parent = this.element.parents(':data(droppable)').filter(
                        function() {
...
(function($, undefined) {
    ...
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _create: function() {
            ...
            this._renderAxis = function(target) {
                ...
                for (var i in this.handles) {
                    ...
                    if (this.elementIsWrapper && this.originalElement[0].nodeName
        ...
        _mouseStop: function(event) {
            ...
            if (this._helper) {
                ...
                var s = {
                    ...
                    left = (parseInt(that.element.css('left'), 10) + (that.position
                        .left - that.originalPosition.left)) || null,
        ...
        _proportionallyResize: function() {
            ...
            for (var i = 0; i < this._proportionallyResizeElements.length; i++) {
                ...
                if (!this.borderDif) {
                    var b = [prel.css('borderTopWidth'), prel.css(
                                'borderRightWidth'), prel.css('borderBottomWidth'),
                            prel.css('borderLeftWidth')
                        ],
                        p = [prel.css('paddingTop'), prel.css('paddingRight'), prel
                            .css('paddingBottom'), prel.css('paddingLeft')
                        ];
                ...
                prel.css({
                    height: (element.height() - this.borderDif[0] - this.borderDif[
                        2]) || 0,
                    width: (element.width() - this.borderDif[1] - this.borderDif[
                        3]) || 0
                });
        ...
        _change: {
            ...
            se: function(event, dx, dy) {
                return $.extend(this._change.s.apply(this, arguments), this._change
                    .e.apply(this, [event, dx, dy]));
            },
            sw: function(event, dx, dy) {
                return $.extend(this._change.s.apply(this, arguments), this._change
                    .w.apply(this, [event, dx, dy]));
            },
            ne: function(event, dx, dy) {
                return $.extend(this._change.n.apply(this, arguments), this._change
                    .e.apply(this, [event, dx, dy]));
            },
                    ...
                    $(exp).each(function() {
                        var el = $(this),
                            ...
                            css = c && c.length ? c : el.parents(ui.originalElement[
                                0]).length ? ['width', 'height'] : ['width',
                                'height', 'top', 'left'
                            ];

                        $.each(css, function(i, prop) {
                            var sum = (start[prop] || 0) + (delta[
                                prop] || 0);
                            if (sum && sum >= 0)
                                style[prop] = sum || null;
                        });
    ...
    $.ui.plugin.add("resizable", "containment", {
        ...
        start: function(event, ui) {
            ...
            var oc = o.containment,
                ce = (oc instanceof $) ? oc.get(0) : (/parent/.test(oc)) ? el.parent()
                .get(0) : oc;
            if (!ce) return;
        ...
        resize: function(event, ui) {
            ...
            if (cp.top < (that._helper ? co.top : 0)) {
                that.size.height = that.size.height + (that._helper ? (that.position
                    .top - co.top) : that.position.top);
            ...
            var woset = Math.abs((that._helper ? that.offset.left - cop.left : (
                    that.offset.left - cop.left)) + that.sizeDiff.width),
                hoset = Math.abs((that._helper ? that.offset.top - cop.top : (that.offset
                    .top - co.top)) + that.sizeDiff.height);

            var isParent = that.containerElement.get(0) == that.element.parent().get(
                    0),
    ...
    $.ui.plugin.add("resizable", "ghost", {
        ...
        stop: function(event, ui) {
            var that = $(this).data("resizable"),
                o = that.options;
            if (that.ghost && that.helper) that.helper.get(0).removeChild(that.ghost
                .get(0));
        }
    ...
    $.ui.plugin.add("resizable", "grid", {
        ...
        resize: function(event, ui) {
            ...
            var ox = Math.round((cs.width - os.width) / (o.grid[0] || 1)) * (o.grid[
                    0] || 1),
                oy = Math.round((cs.height - os.height) / (o.grid[1] || 1)) * (o.grid[
                    1] || 1);
    ...
    $.widget("ui.selectable", $.ui.mouse, {
        ...
        _mouseStop: function(event) {
            ...
            $('.ui-selecting', this.element[0]).each(function() {
                var selectee = $.data(this, "selectable-item");
                selectee.$element.removeClass('ui-selecting').addClass(
                    'ui-selected');
                selectee.selecting = false;
                selectee.selected = true;
                selectee.startselected = true;
...
(function($, undefined) {
    ...
    $.widget("ui.sortable", $.ui.mouse, {
        ...
        _mouseCapture: function(event, overrideHandle) {
            ...
            if ($.data(event.target, that.widgetName + '-item') == that) currentItem =
                $(event.target);
        ...
        _mouseStart: function(event, overrideHandle, noActivation) {
            ...
            if (o.cursor) { // cursor option
                if ($('body').css("cursor")) this._storedCursor = $('body').css(
                    "cursor");
        ...
        _mouseDrag: function(event) {
            ...
            for (var i = this.items.length - 1; i >= 0; i--) {
                ...
                if (itemElement != this.currentItem[0] //cannot intersect with itself
                    ...
                    &&
                    (this.options.type == 'semi-dynamic' ? !$.contains(this.element[
                        0], itemElement) : true)
        ...
        _mouseStop: function(event, noPropagation) {
            ...
            if (this.options.revert) {
                ...
                $(this.helper).animate({
                    left: cur.left - this.offset.parent.left - this.margins
                        .left + (this.offsetParent[0] == document.body ? 0 :
        ...
        cancel: function() {
            ...
            if (this.placeholder) {
                ...
                if (this.placeholder[0].parentNode) this.placeholder[0].parentNode.removeChild(
                    this.placeholder[0]);
                if (this.options.helper != "original" && this.helper && this.helper[
        ...
        _intersectsWith: function(item) {
            ...
            if (this.options.tolerance == "pointer" ||
                ...
                (this.options.tolerance != "pointer" && this.helperProportions[this
                    .floating ? 'width' : 'height'] > item[this.floating ?
                    'width' : 'height'])
            ) {
        ...
        _intersectsWithPointer: function(item) {
            ...
            var isOverElementHeight = (this.options.axis === 'x') || $.ui.isOverAxis(
                ...
                isOverElementWidth = (this.options.axis === 'y') || $.ui.isOverAxis(
                    this.positionAbs.left + this.offset.click.left, item.left, item
                    .width),
        ...
        _intersectsWithSides: function(item) {
            ...
            var isOverBottomHalf = $.ui.isOverAxis(this.positionAbs.top + this.offset
                    .click.top, item.top + (item.height / 2), item.height),
                isOverRightHalf = $.ui.isOverAxis(this.positionAbs.left + this.offset
                    .click.left, item.left + (item.width / 2), item.width),
                verticalDirection = this._getDragVerticalDirection(),
                horizontalDirection = this._getDragHorizontalDirection();
                ...
                for (var i = connectWith.length - 1; i >= 0; i--) {
                    ...
                    for (var j = cur.length - 1; j >= 0; j--) {
                        ...
                        if (inst && inst != this && !inst.options.disabled) {
                            queries.push([$.isFunction(inst.options.items) ? inst.options
                                .items.call(inst.element) : $(inst.options.items,
                                    inst.element).not(".ui-sortable-helper")
            ...
            if (connectWith && this.ready) { //Shouldn't be run the first time through due to massive slow-down
                for (var i = connectWith.length - 1; i >= 0; i--) {
                    ...
                    for (var j = cur.length - 1; j >= 0; j--) {
                        ...
                        if (inst && inst != this && !inst.options.disabled) {
                            queries.push([$.isFunction(inst.options.items) ? inst.options
                                .items.call(inst.element[0], event, {
                                    item: this.currentItem
            ...
            if (!o.placeholder || o.placeholder.constructor == String) {
                ...
                o.placeholder = {
                    element: function() {
                        ...
                        var el = $(document.createElement(that.currentItem[
                                0].nodeName))
                    ...
                    update: function(container, p) {
                        ...
                        if (!p.height()) {
                            p.height(that.currentItem.innerHeight() -
                                parseInt(that.currentItem.css(
                                    'paddingTop') || 0, 10) - parseInt(
                                    that.currentItem.css(
                                        'paddingBottom') || 0, 10));
                        };
                        if (!p.width()) {
                            p.width(that.currentItem.innerWidth() -
                                parseInt(that.currentItem.css(
                                    'paddingLeft') || 0, 10) - parseInt(
        ...
        _contactContainers: function(event) {
            ...
            for (var i = this.containers.length - 1; i >= 0; i--) {
                ...
                if (this._intersectsWith(this.containers[i].containerCache)) {
                    ...
                    if (innermostContainer && $.contains(this.containers[i].element[
                            0], innermostContainer.element[0]))
                        continue;
            ...
            if (this.containers.length === 1) {
                ...
                var sizeProperty = this.containers[innermostIndex].floating ?
                    'width' : 'height';
                var base = this.positionAbs[posProperty] + this.offset.click[
                    posProperty];
                ...
                itemWithLeastDistance ? this._rearrange(event,
                    itemWithLeastDistance, null, true) : this._rearrange(event,
                    null, this.containers[innermostIndex].element, true);
                this._trigger("change", event, this._uiHash());
                this.containers[innermostIndex]._trigger("change", event, this._uiHash(
                    this));
        ...
        _createHelper: function(event) {
            ...
            if (helper[0].style.width == '' || o.forceHelperSize) helper.width(this
                .currentItem.width());
        ...
        _setContainment: function() {
            ...
            if (!(/^(document|window|parent)$/).test(o.containment)) {
                ...
                this.containment = [
                    ...
                    (parseInt($(ce).css("paddingLeft"), 10) || 0) - this.margins
                    .left,
                    co.top + (parseInt($(ce).css("borderTopWidth"), 10) || 0) +
                    (parseInt($(ce).css("paddingTop"), 10) || 0) - this.margins
                    .top,
                    co.left + (over ? Math.max(ce.scrollWidth, ce.offsetWidth) :
                        ce.offsetWidth) - (parseInt($(ce).css("borderLeftWidth"),
                        10) || 0) - (parseInt($(ce).css("paddingRight"), 10) ||
                        0) - this.helperProportions.width - this.margins.left,
                    co.top + (over ? Math.max(ce.scrollHeight, ce.offsetHeight) :
                        ce.offsetHeight) - (parseInt($(ce).css("borderTopWidth"),
                        10) || 0) - (parseInt($(ce).css("paddingBottom"), 10) ||
        ...
        _rearrange: function(event, i, a, hardRefresh) {
            ...
            a ? a[0].appendChild(this.placeholder[0]) : i.item[0].parentNode.insertBefore(
                this.placeholder[0], (this.direction == 'down' ? i.item[0] : i.item[
                    0].nextSibling));
            ...
            this._delay(function() {
                if (counter == this.counter) this.refreshPositions(!
        ...
        _clear: function(event, noPropagation) {
            ...
            if (this.fromOutside && !noPropagation) delayedTriggers.push(function(
                event) {
                this._trigger("receive", event, this._uiHash(this.fromOutside));
            });
            if ((this.fromOutside || this.domPosition.prev != this.currentItem.prev()
                    .not(".ui-sortable-helper")[0] || this.domPosition.parent !=
                    this.currentItem.parent()[0]) && !noPropagation) delayedTriggers
                .push(function(event) {
            ...
            for (var i = this.containers.length - 1; i >= 0; i--) {
                if (!noPropagation) delayedTriggers.push((function(c) {
                    return function(event) {
                        c._trigger("deactivate", event, this._uiHash(
                            this));
                    };
                ...
                if (this.containers[i].containerCache.over) {
                    delayedTriggers.push((function(c) {
                        return function(event) {
                            c._trigger("out", event, this._uiHash(
                                this));
                        };
                    }).call(this, this.containers[i]));
                    this.containers[i].containerCache.over = 0;
                ...
                if (type === "object") {
                    if (red instanceof color) {
                        ...
                        each(spaces, function(spaceName, space) {
                            ...
                            if (inst[cache] && $.inArray(null, inst[
                                    cache].slice(0, 3)) < 0) {
                                // use the default of 1
                                inst[cache][3] = 1;
                                if (space.from) {
                                    inst._rgba = space.from(inst[
                                        cache]);
                                }
                            }
                        });
                    ...
                    if (startValue === null) {
                        ...
                        if (type.mod) {
                            if (endValue - startValue > type.mod /
                                2) {
                                startValue += type.mod;
                            } else if (startValue - endValue > type
                                .mod / 2) {
                                startValue -= type.mod;
                            }
                        }
        ...
        each(stepHooks, function(i, hook) {
            jQuery.cssHooks[hook] = {
                set: function(elem, value) {
                    ...
                    if (jQuery.type(value) !== "string" || (parsed =
                            stringParse(value))) {
                        value = color(parsed || value);
                        if (!support.rgba && value._rgba[3] !== 1) {
                            curElem = hook === "backgroundColor" ? elem
                                .parentNode : elem;
                            while (
                                (backgroundColor === "" ||
    ...
    (function() {
        ...
        $.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle",
            ...
            $.fx.step[prop] = function(fx) {
                if (fx.end !== "none" && !fx.setAttr || fx.pos === 1 && !fx
                    .setAttr) {
        ...
        $.effects.animateClass = function(value, duration, easing, callback) {
            ...
            return this.queue(function() {
                var animated = $(this),
                    ...
                    applyClassChange,
                    allAnimations = o.children ? animated.find("*").andSelf() :
                    animated;
        ...
        $.fn.extend({
            effect: function( /* effect, options, speed, callback */ ) {
                var args = _normalizeArguments.apply(this, arguments),
                    ...
                    oldEffectMethod = !effectMethod && backCompat && $.effects[
                        args.effect];
        ...
        (function($, prototype) {
            ...
            $.extend(prototype, {
                ...
                _setOption: function(key) {
                    if (key === "autoHeight" || key === "clearStyle" || key ===
                        "fillSpace") {
            ...
            this._on(this.menu.element, {
                ...
                menufocus: function(event, ui) {
                    ...
                    if (this.isNewMenu) {
                        ...
                        if (event.originalEvent && /^mouse/.test(event.originalEvent
                                .type)) {
                            this.menu.blur();
                    ...
                    if (false !== this._trigger("focus", event, {
                        ...
                        if (event.originalEvent && /^key/.test(event.originalEvent
                                .type)) {
        ...
        _create: function() {
            ...
            if (this.type === "checkbox") {
                this.buttonElement.bind("click" + this.eventNamespace, function() {
                    ...
                    that.buttonElement.attr("aria-pressed", that.element[0]
                        .checked);
                });
        ...
        _determineButtonType: function() {
            ...
            if (this.type === "checkbox" || this.type === "radio") {
                ...
                if (!this.buttonElement.length) {
                    ancestor = ancestor.length ? ancestor.siblings() : this.element
                        .siblings();
...
(function($, undefined) {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _attachments: function(input, inst) {
            ...
            if (showOn == 'button' || showOn == 'both') { // pop-up date picker when button clicked
                ...
                inst.trigger.click(function() {
                    ...
                    else if ($.datepicker._datepickerShowing && $.datepicker
                        ._lastInput != input[0]) {
                        $.datepicker._hideDatepicker();
        ...
        _doKeyDown: function(event) {
            ...
            if ($.datepicker._datepickerShowing)
                switch (event.keyCode) {
                    ...
                    case 35:
                        if (event.ctrlKey || event.metaKey) $.datepicker._clearDate(
                            event.target);
                        handled = event.ctrlKey || event.metaKey;
                        break; // clear on ctrl or command +end
                    case 36:
                        if (event.ctrlKey || event.metaKey) $.datepicker._gotoToday(
                            event.target);
                        handled = event.ctrlKey || event.metaKey;
                        break; // current on ctrl or command +home
                    case 37:
                        if (event.ctrlKey || event.metaKey) $.datepicker._adjustDate(
                            event.target, (isRTL ? +1 : -1), 'D');
                        handled = event.ctrlKey || event.metaKey;
                        // -1 day on ctrl or command +left
                        if (event.originalEvent.altKey) $.datepicker._adjustDate(
        ...
        _doKeyPress: function(event) {
            ...
            if ($.datepicker._get(inst, 'constrainInput')) {
                var chars = $.datepicker._possibleChars($.datepicker._get(inst,
                    'dateFormat'));
                var chr = String.fromCharCode(event.charCode == undefined ? event.keyCode :
                    event.charCode);
        ...
        _updateDatepicker: function(inst) {
            ...
            if (inst == $.datepicker._curInst && $.datepicker._datepickerShowing &&
                ...
                inst.input.is(':visible') && !inst.input.is(':disabled') && inst.input[
        ...
        _findPos: function(obj) {
            ...
            var isRTL = this._get(inst, 'isRTL');
            while (obj && (obj.type == 'hidden' || obj.nodeType != 1 || $.expr.filters
                    .hidden(obj))) {
            ...
            if (this._datepickerShowing) {
                ...
                if ($.effects && ($.effects.effect[showAnim] || $.effects[showAnim]))
                    ...
                    inst.dpDiv[(showAnim == 'slideDown' ? 'slideUp' :
                        (showAnim == 'fadeIn' ? 'fadeOut' : 'hide'))]((showAnim ?
        ...
        _updateAlternate: function(inst) {
            ...
            if (altField) { // update alternate field too
                var altFormat = this._get(inst, 'altFormat') || this._get(inst,
                    'dateFormat');
                var date = this._getDate(inst);
                var dateStr = this.formatDate(altFormat, date, this._getFormatConfig(
                    inst));
        ...
        parseDate: function(format, value, settings) {
            ...
            var dayNamesShort = (settings ? settings.dayNamesShort : null) || this._defaults
                .dayNamesShort;
            var dayNames = (settings ? settings.dayNames : null) || this._defaults.dayNames;
            var monthNamesShort = (settings ? settings.monthNamesShort : null) ||
                this._defaults.monthNamesShort;
            var monthNames = (settings ? settings.monthNames : null) || this._defaults
                .monthNames;
            var year = -1;
            var month = -1;
            var day = -1;
            ...
            var lookAhead = function(match) {
                var matches = (iFormat + 1 < format.length && format.charAt(
                    iFormat + 1) == match);
                if (matches)
                    iFormat++;
                return matches;
                        ...
                        switch (format.charAt(iFormat)) {
                            ...
                            case 'o':
                                output += formatNumber('o',
                                    ...
                                    ).getTime() - new Date(date.getFullYear(),
        ...
        _determineDate: function(inst, date, defaultDate) {
            ...
            var newDate = (date == null || date === '' ? defaultDate : (typeof date ==
        ...
        _attachHandlers: function(inst) {
            ...
            inst.dpDiv.find('[data-handler]').map(function() {
                var handler = {
                    ...
                    selectDay: function() {
                        window['DP_jQuery_' + dpuuid].datepicker._selectDay(
                            id, +this.getAttribute('data-month'),
                ...
                $(this).bind(this.getAttribute('data-event'), handler[this.getAttribute(
                    'data-handler')]);
            });
        },
        ...
        _generateHTML: function(inst) {
            ...
            var currentDate = this._daylightSavingAdjust((!inst.currentDay ? new Date(
                    9999, 9, 9) :
            ...
            currentText = (!navigationAsDateFormat ? currentText :
                this.formatDate(currentText, gotoDate, this._getFormatConfig(
                    inst)));
                ...
                for (var col = 0; col < numMonths[1]; col++) {
                    ...
                    calender +=
                        ...
                        (/all|right/.test(cornerClass) && row == 0 ? (isRTL ? prev :
                            next) : '') +
                        this._generateMonthYearHeader(inst, drawMonth, drawYear,
                            minDate, maxDate,
                    ...
                    for (var dow = 0; dow < 7; dow++) { // days of the week
                        ...
                        thead += '<th' + ((dow + firstDay + 6) % 7 >= 5 ?
                            ...
                            '<span title="' + dayNames[day] + '">' + dayNamesMin[
                                day] + '</span></th>';
                    }
                    ...
                    for (var dRow = 0; dRow < numRows; dRow++) { // create date picker rows
                        ...
                        for (var dow = 0; dow < 7; dow++) { // create date picker days
                            var daySettings = (beforeShowDay ?
                                beforeShowDay.apply((inst.input ? inst.input[0] :
                                    null), [printDate]) : [true, '']);
        ...
        _generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
            ...
            if (secondary || !changeMonth)
                monthHtml += '<span class="ui-datepicker-month">' + monthNames[
                    drawMonth] + '</span>';
            else {
        ...
        _canAdjustMonth: function(inst, offset, curYear, curMonth) {
            ...
            var date = this._daylightSavingAdjust(new Date(curYear,
                curMonth + (offset < 0 ? offset : numMonths[0] * numMonths[
                    1]), 1));
            if (offset < 0)
        ...
        _formatDate: function(inst, day, month, year) {
            ...
            var date = (day ? (typeof day == 'object' ? day :
                ...
                this._daylightSavingAdjust(new Date(inst.currentYear, inst.currentMonth,
                    inst.currentDay)));
            return this.formatDate(this._get(inst, 'dateFormat'), date, this._getFormatConfig(
                inst));
        }
    });
    ...
    function bindHover(dpDiv) {
        ...
        return dpDiv.delegate(selector, 'mouseout', function() {
                ...
                if (this.className.indexOf('ui-datepicker-prev') != -1) $(this).removeClass(
                    'ui-datepicker-prev-hover');
                if (this.className.indexOf('ui-datepicker-next') != -1) $(this).removeClass(
                    'ui-datepicker-next-hover');
            })
            .delegate(selector, 'mouseover', function() {
                if (!$.datepicker._isDisabledDatepicker(instActive.inline ? dpDiv.parent()[
                        0] : instActive.input[0])) {
                    $(this).parents('.ui-datepicker-calendar').find('a').removeClass(
                        'ui-state-hover');
                    $(this).addClass('ui-state-hover');
                    if (this.className.indexOf('ui-datepicker-prev') != -1) $(this).addClass(
                        'ui-datepicker-prev-hover');
                    if (this.className.indexOf('ui-datepicker-next') != -1) $(this).addClass(
                        'ui-datepicker-next-hover');
                }
            });
    }
    ...
    $.widget("ui.dialog", {
        ...
        _create: function() {
            ...
            uiDialog = (this.uiDialog = $("<div>"))
                ...
                .attr("tabIndex", -1)
                .keydown(function(event) {
                    if (options.closeOnEscape && !event.isDefaultPrevented() &&
                        event.keyCode &&
            ...
            this._on(uiDialog, {
                keydown: function(event) {
                    if (!options.modal || event.keyCode !== $.ui.keyCode
                        .TAB) {
                        return;
                    }
        ...
        _position: function(position) {
            ...
            if (position) {
                ...
                if (typeof position === "string" || (typeof position === "object" &&
                    ...
                    position = {
                        my: myAt[0] + (offset[0] < 0 ? offset[0] : "+" + offset[
                                0]) + " " +
                            myAt[1] + (offset[1] < 0 ? offset[1] : "+" + offset[
                                1]),
                        at: myAt.join(" ")
                    };
                }
    ...
    $.extend($.ui.dialog.overlay, {
        ...
        create: function(dialog) {
                    ...
                    if ($.ui.dialog.overlay.instances.length) {
                        $(document).bind($.ui.dialog.overlay.events,
                            function(event) {
                                ...
                                if ($(event.target).zIndex() < $.ui.dialog
                                    .overlay.maxZ) {
                                    return false;
                                }
                            });
            ...
            $(document).bind("keydown.dialog-overlay", function(event) {
                ...
                if (instances.length !== 0 && instances[instances.length -
                        1] === $el &&
...
(function($, undefined) {
    ...
    $.effects.effect.drop = function(o, done) {
        ...
        var el = $(this),
            props = ["position", "top", "bottom", "left", "right", "opacity", "height",
                "width"
            ],
            mode = $.effects.setMode(el, o.mode || "hide"),
            show = mode === "show",
...
(function($, undefined) {
    ...
    $.effects.effect.fold = function(o, done) {
        ...
        distance = widthFirst ? [wrapper.width(), wrapper.height()] : [wrapper.height(),
            wrapper.width()
        ];
...
(function($, undefined) {
    ...
    $.effects.effect.size = function(o, done) {
        ...
        var original, baseline, factor,
            el = $(this),
            props0 = ["position", "top", "bottom", "left", "right", "width", "height",
                "overflow", "opacity"
            ],
        ...
        if (scale === "content" || scale === "both") { // Scale the children
            ...
            el.find("*[width]").each(function() {
                ...
                // Vertical props scaling
                if (factor.from.y !== factor.to.y) {
                    child.from = $.effects.setTransition(child, vProps, factor.from
                        .y, child.from);
                ...
                // Horizontal props scaling
                if (factor.from.x !== factor.to.x) {
                    child.from = $.effects.setTransition(child, hProps, factor.from
                        .x, child.from);
    ...
    $.widget("ui.menu", {
        ...
        _create: function() {
            ...
            this._on({
                ...
                "click .ui-menu-item:has(a)": function(event) {
                    ...
                    if (!mouseHandled && target.not(
                        ...
                        if (target.has(".ui-menu").length) {
                            ...
                            if (this.active && this.active.parents(
                                    ".ui-menu").length === 1) {
                ...
                focus: function(event, keepActiveItem) {
                    ...
                    var item = this.active || this.element.children(
                        ".ui-menu-item").eq(0);
                ...
                blur: function(event) {
                    this._delay(function() {
                        if (!$.contains(this.element[0], this.document[
                                0].activeElement)) {
        ...
        collapseAll: function(event, all) {
            ...
            this.timer = this._delay(function() {
                ...
                var currentMenu = all ? this.element :
                    $(event && event.target).closest(this.element.find(
                        ".ui-menu"));
        ...
        nextPage: function(event) {
            ...
            if (this._hasScroll()) {
                ...
                this.focus(event, this.activeMenu.children(".ui-menu-item")[!this.active ?
                    "first" : "last"]());
            }
        },
            ...
            if (this.options.values && this.options.values.length) {
                this.handles.each(function(i) {
                    ...
                    _set[that.orientation === "horizontal" ? "left" :
                        "bottom"] = valPercent + "%";
                    $(this).stop(1, 1)[animate ? "animate" : "css"](_set, o
                        .animate);
    ...
    $.widget("ui.spinner", {
        ...
        _events: {
            ...
            "mousedown .ui-spinner-button": function(event) {
                ...
                this._repeat(null, $(event.currentTarget).hasClass("ui-spinner-up") ?
                    1 : -1, event);
            },
        ...
        _tabKeydown: function(event) {
            ...
            switch (event.keyCode) {
                ...
                case $.ui.keyCode.ENTER:
                    ...
                    this._activate(selectedIndex === this.options.active ? false :
                        selectedIndex);
                    return;
                default:
                    return;
    ...
    if ($.uiBackCompat !== false) {
                ...
                return $.extend({}, ajaxOptions, {
                    error: function(xhr, status) {
                        try {
                            ...
                            ajaxOptions.error(
                                xhr, status, ui.tab.closest("li").index(),
                                ui.tab[0]);
                        } catch (error) {}
                    }
                }, this._superApply(arguments));
        ...
        $.widget("ui.tabs", $.ui.tabs, {
            ...
            enable: function(index) {
                ...
                if (index && options.disabled === true ||
                    ($.isArray(options.disabled) && $.inArray(index, options.disabled) !==
                        -1)) {
                    trigger = true;
                }
        ...
        $.widget("ui.tabs", $.ui.tabs, {
            ...
            add: function(url, label, index) {
                ...
                this._trigger("add", null, this._ui(this.anchors[index], this.panels[
                    index]));
                return this;
            },
            ...
            remove: function(index) {
                ...
                if (tab.hasClass("ui-tabs-active") && this.anchors.length > 2) {
                    this._activate(index + (index + 1 < this.anchors.length ? 1 : -
                        1));
                }
        ...
        $.widget("ui.tabs", $.ui.tabs, {
            ...
            _tabId: function(tab) {
                ...
                return $(a).closest("li").attr("aria-controls") ||
                    a.title && a.title.replace(/\s/g, "_").replace(
                        /[^\w\u00c0-\uFFFF\-]/g, "") ||
