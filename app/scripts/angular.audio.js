...
angular.module('ngAudio', [])
    ...
    .service('cleverAudioFindingService', ['$q', 'localAudioFindingService',
        'remoteAudioFindingService',
        function($q, localAudioFindingService, remoteAudioFindingService) {
            this.find = function(id) {
                var deferred = $q.defer();
    ...
    .factory('NgAudioObject', ['cleverAudioFindingService', '$rootScope', '$interval', '$timeout',
        'ngAudioGlobals',
        function(cleverAudioFindingService, $rootScope, $interval, $timeout, ngAudioGlobals) {
            return function(id) {
                ...
                function checkWatchers() {
                    ...
                    if (audio) {
                        ...
                        if ($isMuting || ngAudioGlobals.isMuting) {
                            ...
                            audio.volume = audioObject.volume !== undefined ? audioObject.volume :
                                1;
                        }
