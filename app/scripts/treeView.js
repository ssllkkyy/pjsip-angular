            ...
            link: function(scope, element, attrs, controller) {
                ...
                scope.hasChildren = function() {
                    ...
                    return Boolean(node && (node[foldersProperty] && node[
                        foldersProperty].length) || (node[
                        filesProperty] && node[filesProperty].length));
                };
                ...
                */
                ...
                function render() {
                    var template =
                        ...
                        '<span class="tree-folder-name">{{ node.' +
                        ...
                        '</div>' +
                        (showFiles ?
                            '<a href="#" class="tree-item" ng-repeat="file in ' +
                            attrs.treeViewNode + '.' + filesProperty +
