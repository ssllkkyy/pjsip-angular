...
(function(root, factory) {
    ...
    wdtEmojiBundle.init = function(selector) {
        ...
        console.log(this.defaults.emojiSheets);
    ...
    wdtEmojiBundle.openPicker = function(ev) {
        ...
        function findBestAvailablePosition(el) {
            ...
            var pos = {
                //left: (elRect.left - popupRect.width) + elRect.width,
                left: bodyRect.right - popupRect.width - 30,
                //top : elRect.top + Math.abs(bodyRect.top) + elRect.height
                top: elRect.top - 300 - 60
            };
    ...
    wdtEmojiBundle.fillPickerPopup = function() {
        ...
        var sortedSectionsArray = Object.keys(sections).sort(function(a, b) {
            return wdtEmojiBundle.defaults.sectionOrders[a] < wdtEmojiBundle.defaults
                .sectionOrders[b] ? 1 : -1;
        });
            ...
            if (sortedSections.hasOwnProperty(title)) {
                ...
                if (emojiList.length) {
                    ...
                    for (i = 0; i < emojiList.length; i++) {
                        ...
                        if (em.has_img_apple || em.has_img_emojione || em.has_img_google ||
                            em.has_img_twitter || em.has_img_facebook || em.has_img_messenger
                        ) {
    ...
    wdtEmojiBundle.getRandomPickerColor = function() {
        return wdtEmojiBundle.defaults.pickerColors[Math.floor(Math.random() *
            wdtEmojiBundle.defaults.pickerColors.length)]
    };
    ...
    wdtEmojiBundle.bindEvents = function() {
        ...
        live('mouseover', '.wdt-emoji-list a.wdt-emoji', function(event) {
            ...
            wdtEmojiBundle.previewTimer = setTimeout(function() {
                ...
                wdtEmojiBundle.previewImg.innerHTML = self.emoji.replace_colons(
                    ':' + emo.dataset.wdtEmojiShortname + ':');
        ...
        live('click', '.wdt-emoji-tab', function(e) {
            var group = this.dataset.groupName,
                groupHeader = wdtEmojiBundle.popup.querySelector(
                    '.wdt-emoji-section h3[data-emoji-group="' + group + '"]');

            if (groupHeader) {
                wdtEmojiBundle.setActiveTab(group);
                wdtEmojiBundle.scroller.scrollTop = groupHeader.offsetTop -
                    groupHeader.getBoundingClientRect().height - 2;
            }
        ...
        addListenerMulti(wdtEmojiBundle.scroller, 'mousewheel DOMMouseScroll', function(e) {
            var delta = e.wheelDelta || (e.originalEvent && e.originalEvent.wheelDelta) ||
                -e.detail,
                bottomOverflow = this.scrollTop + this.getBoundingClientRect().height -
                this.scrollHeight >= 0,
    ...
    wdtEmojiBundle.search = function(q) {
        ...
        var sections = wdtEmojiBundle.popup.querySelector('.wdt-emoji-sections'),
            searchResultH3 = wdtEmojiBundle.popup.querySelector(
    ...
    wdtEmojiBundle.render = function(text) {
        return this.emoji.replace_colons(this.emoji.replace_emoticons(this.emoji.replace_unified(
            text)));
    };
    ...
    wdtEmojiBundle.addRangeStore = function(el) {
        ...
        addListenerMulti(el, 'mouseup keyup', function() {
            wdtEmojiBundle.ranges[this.dataset.rangeIndex] = window.getSelection().getRangeAt(
                0);
        });
    ...
    var sticky = function(el) {
        ...
        var scrollerRect = wdtEmojiBundle.scroller.getBoundingClientRect(),
            ...
            tabHeaderHeight = wdtEmojiBundle.popup.querySelector('#wdt-emoji-menu-header').getBoundingClientRect()
            .height;
    ...
    wdtEmojiBundle.setActiveTab = function(group) {
        ...
        var activeTab = wdtEmojiBundle.popup.querySelector(
            '.wdt-emoji-tab[data-group-name="' + group + '"]');
    ...
    var css = (function() {
        ...
        function camelCase(string) {
            return string.replace(/^-ms-/, 'ms-').replace(/-([\da-z])/gi, function(
                match, letter) {
