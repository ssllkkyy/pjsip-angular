...
(function() {
    ...
    emoji.prototype.replace_emoticons_with_colons = function(str) {
        ...
        var str_replaced = str.replace(self.rx_emoticons, function(m, $1, emoticon, offset) {
             ...
             */
            if ((has_open_paren || has_close_paren) && emoticons_with_parens.indexOf(
                    emoticon) == -1) {
        ...
        if (emoticons_with_parens.length) {
            ...
            var parenthetical_rx = new RegExp('(\\(.+)(' + escaped_emoticons.join('|') +
                ')(.+\\))', 'g');

            str_replaced = str_replaced.replace(parenthetical_rx, function(m, $1, emoticon,
                $2) {
                var val = self.data[self.map.emoticons[emoticon]][3][0];
    ...
    emoji.prototype.replacement = function(idx, actual, wrapper, variation) {
        ...
        if ((!self.use_sheet || !self.supports_css) && !(self.data[idx][6] & self.img_sets[
                self.img_set].mask)) {
            img_set = 'apple';
        }
        ...
        var text_name = (actual) ? wrapper + actual + wrapper : self.data[idx][8] ||
            wrapper + self.data[idx][3][0] + wrapper;
        if (self.text_mode) return text_name + extra;

        // native modes next.
        // for variations selectors, we just need to output them raw, which `extra` will contain.
        self.init_env();
        if (self.replace_mode == 'unified' && self.allow_native && self.data[idx][0][0])
            return self.data[idx][0][0] + extra;
        if (self.replace_mode == 'softbank' && self.allow_native && self.data[idx][1])
            return self.data[idx][1] + extra;
        if (self.replace_mode == 'google' && self.allow_native && self.data[idx][2]) return self
            .data[idx][2] + extra;
        ...
        if (variation_idx && self.variations_data[variation_idx] && self.variations_data[
                variation_idx][2] && !self.data[idx][7]) {
        ...
        if (self.supports_css) {
            if (self.use_sheet && px != null && py != null) {
                ...
                var style = 'background: url(' + self.img_sets[img_set].sheet +
                    ');background-position:' + (mul * px) + '% ' + (mul * py) +
                    '%;background-size:' + self.sheet_size + '00%';
                return '<span class="emoji-outer emoji-sizer"><span class="emoji-inner" style="' +
                    style + '"' + title + ' data-codepoints="' + full_idx + '">' + text +
                    '</span></span>' + extra;
            } else if (self.use_css_imgs) {
                return '<span class="emoji emoji-' + idx + '"' + title +
                    ' data-codepoints="' + full_idx + '">' + text + '</span>' + extra;
            } else {
                return '<span class="emoji emoji-sizer" style="background-image:url(' + img +
                    ')"' + title + ' data-codepoints="' + full_idx + '">' + text +
                    '</span>' + extra;
            }
        }
        return '<img src="' + img + '" class="emoji" data-codepoints="' + full_idx + '" ' +
            title + '/>' + extra;
    };
    ...
    emoji.prototype.init_emoticons = function() {
        ...
        self.rx_emoticons = new RegExp(('(^|\\s)(' + a.join('|') + ')(?=$|[\\s|\\?\\.,!])'),
            'g');
    };
    ...
    emoji.prototype.data = {
        ...
        "2195": [
            ["\u2195\uFE0F", "\u2195"], "", "\uDBBA\uDEF7", ["arrow_up_down"], 0, 7, 15,
            0
        ],
        "2196": [
            ["\u2196\uFE0F", "\u2196"], "\uE237", "\uDBBA\uDEF2", ["arrow_upper_left"],
            0, 8, 15, 0
        ],
        "2197": [
            ["\u2197\uFE0F", "\u2197"], "\uE236", "\uDBBA\uDEF0", ["arrow_upper_right"],
            0, 9, 15, 0
        ],
        "2198": [
            ["\u2198\uFE0F", "\u2198"], "\uE238", "\uDBBA\uDEF1", ["arrow_lower_right"],
            0, 10, 15, 0
        ],
        "2199": [
            ["\u2199\uFE0F", "\u2199"], "\uE239", "\uDBBA\uDEF3", ["arrow_lower_left"],
            0, 11, 15, 0
        ],
        "21a9": [
            ["\u21A9\uFE0F", "\u21A9"], "", "\uDBBA\uDF83", [
        ...
        "25aa": [
            ["\u25AA\uFE0F", "\u25AA"], "\uE21A", "\uDBBA\uDF6E", ["black_small_square"],
            0, 33, 15, 0
        ],
        "25ab": [
            ["\u25AB\uFE0F", "\u25AB"], "\uE21B", "\uDBBA\uDF6D", ["white_small_square"],
            0, 34, 15, 0
        ],
        "25b6": [
            ["\u25B6\uFE0F", "\u25B6"], "\uE23A", "\uDBBA\uDEFC", ["arrow_forward"], 0,
        ...
        "274e": [
            ["\u274E"], "\uE333", "\uDBBA\uDF46", ["negative_squared_cross_mark"], 4, 4,
            15, 0
        ],
        "2753": [
            ["\u2753"], "\uE020", "\uDBBA\uDF09", ["question"], 4, 5, 15, 0
        ...
        "2934": [
            ["\u2934\uFE0F", "\u2934"], "\uE236", "\uDBBA\uDEF4", ["arrow_heading_up"],
            4, 17, 15, 0
        ],
        "2935": [
            ["\u2935\uFE0F", "\u2935"], "\uE238", "\uDBBA\uDEF5", ["arrow_heading_down"],
            4, 18, 15, 0
        ],
        "2b05": [
            ["\u2B05\uFE0F", "\u2B05"], "\uE235", "\uDBBA\uDEFB", ["arrow_left"], 4, 19,
        ...
        "2b1b": [
            ["\u2B1B\uFE0F", "\u2B1B"], "\uE21A", "\uDBBA\uDF6C", ["black_large_square"],
            4, 22, 15, 0
        ],
        "2b1c": [
            ["\u2B1C\uFE0F", "\u2B1C"], "\uE21B", "\uDBBA\uDF6B", ["white_large_square"],
            4, 23, 15, 0
        ],
        "2b50": [
            ["\u2B50\uFE0F", "\u2B50"], "\uE32F", "\uDBBA\uDF68", ["star"], 4, 24, 15,
        ...
        "1f302": [
            ["\uD83C\uDF02"], "\uE43C", "\uDBB8\uDC07", ["closed_umbrella"], 5, 23, 15,
            0
        ],
        "1f303": [
            ["\uD83C\uDF03"], "\uE44B", "\uDBB8\uDC08", ["night_with_stars"], 5, 24, 15,
            0
        ],
        "1f304": [
            ["\uD83C\uDF04"], "\uE04D", "\uDBB8\uDC09", ["sunrise_over_mountains"], 5,
            25, 15, 0
        ],
        "1f305": [
            ["\uD83C\uDF05"], "\uE449", "\uDBB8\uDC0A", ["sunrise"], 5, 26, 15, 0
        ...
        "1f313": [
            ["\uD83C\uDF13"], "\uE04C", "\uDBB8\uDC13", ["first_quarter_moon"], 5, 40,
            15, 0
        ],
        "1f314": [
            ["\uD83C\uDF14"], "\uE04C", "\uDBB8\uDC12", ["moon", "waxing_gibbous_moon"],
            6, 0, 15, 0
        ],
        "1f315": [
        ...
        "1f325": [
            ["\uD83C\uDF25"], "", "", ["barely_sunny", "sun_behind_cloud"], 6, 15, 15,
            0
        ],
        "1f326": [
            ["\uD83C\uDF26"], "", "", ["partly_sunny_rain", "sun_behind_rain_cloud"], 6,
            16, 15, 0
        ],
        "1f327": [
        ...
        "1f383": [
            ["\uD83C\uDF83"], "\uE445", "\uDBB9\uDD1F", ["jack_o_lantern"], 8, 27, 15,
            0
        ],
        "1f384": [
            ["\uD83C\uDF84"], "\uE033", "\uDBB9\uDD12", ["christmas_tree"], 8, 28, 15,
            0
        ],
        "1f385": [
            ["\uD83C\uDF85"], "\uE448", "\uDBB9\uDD13", ["santa"], 8, 29, 15, 0
        ...
        "1f3a2": [
            ["\uD83C\uDFA2"], "\uE433", "\uDBB9\uDFFE", ["roller_coaster"], 9, 17, 15,
            0
        ],
        "1f3a3": [
            ["\uD83C\uDFA3"], "\uE019", "\uDBB9\uDFFF", ["fishing_pole_and_fish"], 9,
            18, 15, 0
        ],
        "1f3a4": [
        ...
        "1f3b4": [
            ["\uD83C\uDFB4"], "", "\uDBBA\uDC11", ["flower_playing_cards"], 9, 35, 15,
            0
        ],
        "1f3b5": [
        ...
        "1f3bd": [
            ["\uD83C\uDFBD"], "", "\uDBB9\uDFD0", ["running_shirt_with_sash"], 10, 3,
            15, 0
        ],
        "1f3be": [
            ["\uD83C\uDFBE"], "\uE015", "\uDBB9\uDFD3", ["tennis"], 10, 4, 15, 0
        ...
        "1f3ee": [
            ["\uD83C\uDFEE"], "\uE30B", "\uDBB9\uDCC2", ["izakaya_lantern", "lantern"],
            11, 31, 15, 0
        ],
        "1f3ef": [
            ["\uD83C\uDFEF"], "\uE505", "\uDBB9\uDCBE", ["japanese_castle"], 11, 32, 15,
            0
        ],
        "1f3f0": [
            ["\uD83C\uDFF0"], "\uE506", "\uDBB9\uDCBF", ["european_castle"], 11, 33, 15,
            0
        ],
        "1f3f3": [
        ...
        "1f3f8": [
            ["\uD83C\uDFF8"], "", "", ["badminton_racquet_and_shuttlecock"], 11, 38, 15,
            0
        ],
        "1f3f9": [
        ...
        "1f44d": [
            ["\uD83D\uDC4D"], "\uE00E", "\uDBBA\uDF97", ["+1", "thumbsup"], 15, 4, 15,
            0
        ],
        "1f44e": [
            ["\uD83D\uDC4E"], "\uE421", "\uDBBA\uDFA0", ["-1", "thumbsdown"], 15, 10,
            15, 0
        ],
        "1f44f": [
            ["\uD83D\uDC4F"], "\uE41F", "\uDBBA\uDF9E", ["clap"], 15, 16, 15, 0
        ...
        "1f471": [
            ["\uD83D\uDC71"], "\uE515", "\uDBB8\uDDA4", ["person_with_blond_hair"], 17,
            8, 15, 0
        ],
        "1f472": [
            ["\uD83D\uDC72"], "\uE516", "\uDBB8\uDDA5", ["man_with_gua_pi_mao"], 17, 14,
            15, 0
        ],
        "1f473": [
            ["\uD83D\uDC73"], "\uE517", "\uDBB8\uDDA6", ["man_with_turban"], 17, 20, 15,
            0
        ],
        "1f474": [
        ...
        "1f499": [
            ["\uD83D\uDC99"], "\uE32A", "\uDBBA\uDF13", ["blue_heart"], 20, 0, 15, 0,
            "<3"
        ],
        "1f49a": [
            ["\uD83D\uDC9A"], "\uE32B", "\uDBBA\uDF14", ["green_heart"], 20, 1, 15, 0,
            "<3"
        ],
        "1f49b": [
            ["\uD83D\uDC9B"], "\uE32C", "\uDBBA\uDF15", ["yellow_heart"], 20, 2, 15, 0,
            "<3"
        ],
        "1f49c": [
            ["\uD83D\uDC9C"], "\uE32D", "\uDBBA\uDF16", ["purple_heart"], 20, 3, 15, 0,
            "<3"
        ],
        "1f49d": [
        ...
        "1f49e": [
            ["\uD83D\uDC9E"], "\uE327", "\uDBBA\uDF18", ["revolving_hearts"], 20, 5, 15,
            0
        ],
        "1f49f": [
            ["\uD83D\uDC9F"], "\uE204", "\uDBBA\uDF19", ["heart_decoration"], 20, 6, 15,
            0
        ],
        "1f4a0": [
            ["\uD83D\uDCA0"], "", "\uDBBA\uDF55", ["diamond_shape_with_a_dot_inside"],
            20, 7, 15, 0
        ],
        "1f4a1": [
            ["\uD83D\uDCA1"], "\uE10F", "\uDBBA\uDF56", ["bulb"], 20, 8, 15, 0
        ...
        "1f4b1": [
            ["\uD83D\uDCB1"], "\uE149", "\uDBB9\uDCDE", ["currency_exchange"], 20, 29,
            15, 0
        ],
        "1f4b2": [
            ["\uD83D\uDCB2"], "\uE12F", "\uDBB9\uDCE0", ["heavy_dollar_sign"], 20, 30,
            15, 0
        ],
        "1f4b3": [
        ...
        "1f4c3": [
            ["\uD83D\uDCC3"], "\uE301", "\uDBB9\uDD40", ["page_with_curl"], 21, 6, 15,
            0
        ],
        "1f4c4": [
            ["\uD83D\uDCC4"], "\uE301", "\uDBB9\uDD41", ["page_facing_up"], 21, 7, 15,
            0
        ],
        "1f4c5": [
            ["\uD83D\uDCC5"], "", "\uDBB9\uDD42", ["date"], 21, 8, 15, 0
        ...
        "1f4c9": [
            ["\uD83D\uDCC9"], "", "\uDBB9\uDD4C", ["chart_with_downwards_trend"], 21,
            12, 15, 0
        ],
        "1f4ca": [
        ...
        "1f4dd": [
            ["\uD83D\uDCDD"], "\uE301", "\uDBB9\uDD27", ["memo", "pencil"], 21, 32, 15,
            0
        ],
        "1f4de": [
            ["\uD83D\uDCDE"], "\uE009", "\uDBB9\uDD24", ["telephone_receiver"], 21, 33,
            15, 0
        ],
        "1f4df": [
            ["\uD83D\uDCDF"], "", "\uDBB9\uDD22", ["pager"], 21, 34, 15, 0
        ...
        "1f4e8": [
            ["\uD83D\uDCE8"], "\uE103", "\uDBB9\uDD2A", ["incoming_envelope"], 22, 2,
            15, 0
        ],
        "1f4e9": [
            ["\uD83D\uDCE9"], "\uE103", "\uDBB9\uDD2B", ["envelope_with_arrow"], 22, 3,
            15, 0
        ],
        "1f4ea": [
            ["\uD83D\uDCEA"], "\uE101", "\uDBB9\uDD2C", ["mailbox_closed"], 22, 4, 15,
            0
        ],
        "1f4eb": [
            ["\uD83D\uDCEB"], "\uE101", "\uDBB9\uDD2D", ["mailbox"], 22, 5, 15, 0
        ...
        "1f4f3": [
            ["\uD83D\uDCF3"], "\uE250", "\uDBBA\uDC39", ["vibration_mode"], 22, 13, 15,
            0
        ],
        "1f4f4": [
            ["\uD83D\uDCF4"], "\uE251", "\uDBBA\uDC3A", ["mobile_phone_off"], 22, 14,
            15, 0
        ],
        "1f4f5": [
        ...
        "1f50f": [
            ["\uD83D\uDD0F"], "\uE144", "\uDBBA\uDF90", ["lock_with_ink_pen"], 22, 40,
            15, 0
        ],
        "1f510": [
            ["\uD83D\uDD10"], "\uE144", "\uDBBA\uDF8A", ["closed_lock_with_key"], 23, 0,
            15, 0
        ],
        "1f511": [
            ["\uD83D\uDD11"], "\uE03F", "\uDBBA\uDF82", ["key"], 23, 1, 15, 0
        ...
        "1f532": [
            ["\uD83D\uDD32"], "\uE21A", "\uDBBA\uDF64", ["black_square_button"], 23, 34,
            15, 0
        ],
        "1f533": [
            ["\uD83D\uDD33"], "\uE21B", "\uDBBA\uDF67", ["white_square_button"], 23, 35,
            15, 0
        ],
        "1f534": [
        ...
        "1f535": [
            ["\uD83D\uDD35"], "\uE21A", "\uDBBA\uDF64", ["large_blue_circle"], 23, 37,
            15, 0
        ],
        "1f536": [
            ["\uD83D\uDD36"], "\uE21B", "\uDBBA\uDF73", ["large_orange_diamond"], 23,
            38, 15, 0
        ],
        "1f537": [
            ["\uD83D\uDD37"], "\uE21B", "\uDBBA\uDF74", ["large_blue_diamond"], 23, 39,
            15, 0
        ],
        "1f538": [
            ["\uD83D\uDD38"], "\uE21B", "\uDBBA\uDF75", ["small_orange_diamond"], 23,
            40, 15, 0
        ],
        "1f539": [
            ["\uD83D\uDD39"], "\uE21B", "\uDBBA\uDF76", ["small_blue_diamond"], 24, 0,
            15, 0
        ],
        "1f53a": [
        ...
        "1f53b": [
            ["\uD83D\uDD3B"], "", "\uDBBA\uDF79", ["small_red_triangle_down"], 24, 2,
            15, 0
        ],
        "1f53c": [
        ...
        "1f574": [
            ["\uD83D\uDD74"], "", "", ["man_in_business_suit_levitating"], 24, 38, 15,
            0
        ],
        "1f575": [
        ...
        "1f590": [
            ["\uD83D\uDD90"], "", "", ["raised_hand_with_fingers_splayed"], 25, 13, 15,
            0
        ],
        "1f595": [
            ["\uD83D\uDD95"], "", "", ["middle_finger",
        ...
        "1f684": [
            ["\uD83D\uDE84"], "\uE435", "\uDBB9\uDFE2", ["bullettrain_side"], 29, 16,
            15, 0
        ],
        "1f685": [
            ["\uD83D\uDE85"], "\uE01F", "\uDBB9\uDFE3", ["bullettrain_front"], 29, 17,
            15, 0
        ],
        "1f686": [
            ["\uD83D\uDE86"], "", "", ["train2"], 29, 18, 15, 0
        ...
        "1f6a8": [
            ["\uD83D\uDEA8"], "\uE432", "\uDBB9\uDFF9", ["rotating_light"], 30, 16, 15,
            0
        ],
        "1f6a9": [
            ["\uD83D\uDEA9"], "", "\uDBBA\uDF22", ["triangular_flag_on_post"], 30, 17,
            15, 0
        ],
        "1f6aa": [
            ["\uD83D\uDEAA"], "", "\uDBB9\uDCF3", ["door"], 30, 18, 15, 0
