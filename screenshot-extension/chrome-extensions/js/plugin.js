...
loadjQueryThings = function() {
    ...
    $.ajaxPrefilter(function(settings, orgSettings, xhr) {
        if (settings.showProgress) {
            var html = $('<center class=progresscancel><div>Saving Online...<br><div style=height:20px;background-color:skyblue;margin-top name=progressbar></div><button name=cancel>Cancel</button></div></center>');
